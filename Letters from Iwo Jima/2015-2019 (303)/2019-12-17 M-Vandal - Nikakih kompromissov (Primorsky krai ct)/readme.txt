Received: from mx1.rkn.gov.ru (mx1.rkn.gov.ru [87.226.213.147]) (using TLSv1.2 with
 ...
 mail17i.protonmail.ch (Postfix) with ESMTPS id 55C9F3000077 for <pontorez@pm.me>; Tue,
 17 Dec 2019 11:01:21 +0000 (UTC)
Authentication-Results: mail17i.protonmail.ch; dmarc=pass (p=quarantine dis=none)
 header.from=rkn.gov.ru
Authentication-Results: mail17i.protonmail.ch; spf=pass
 smtp.mailfrom=zapret-info-out@rkn.gov.ru
Authentication-Results: mail17i.protonmail.ch; dkim=pass (1024-bit key)
 header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="CXlw4cUR"
X-Client-Proxied-By: ROSKOMNADZOR Secured Mail Server
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1576580480;
 bh=JNv1hxNpau1Fjqp1Nd8mbIJ5yrBXJAaajAMJmjhq0Ps=; h=From:To:Subject:Date;
 b=CXlw4cUR8yQm8IyNVkgV8qY25ZkHLoYFeGOMKU6uDBlWZhDrIHPDKZcwfUJTmFTVP
  psoSufsAP85vC0bwsZI1/qT3XcwomhT2FUcMaUeAf6lZWdgXXi/hucxJ/J6y5JgmRP
  3/phIi8m24nfbOjG5y4rX51q1HNFCIPkGy81K0ss=
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@pontorez.com>, <pontorez@pm.me>, <abuse@ovh.ca>
Subject: [eais#992382] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Tue, 17 Dec 2019 14:01:19 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/nikakih-kompromissov-3 .
