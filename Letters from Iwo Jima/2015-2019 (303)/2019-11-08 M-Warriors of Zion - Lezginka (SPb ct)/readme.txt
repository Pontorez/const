Received: from mx1.rkn.gov.ru (mx1.rsoc.ru [87.226.213.147]) (using TLSv1.2 with cipher
 ...
 mailin007.protonmail.ch (Postfix) with ESMTPS id 68E623000257 for <pontorez@pm.me>; Fri,
  8 Nov 2019 08:11:22 +0000 (UTC)
...
Authentication-Results: mailin007.protonmail.ch; dkim=pass (1024-bit key)
 header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="Vdp2Yr7h"
...
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1573200681;
 bh=j56RUjTJ06trNwlIWUl1HUHymy8WMOuBYkqvpHNXC/o=; h=From:To:Subject:Date;
 b=Vdp2Yr7hFI2NjjUoEQNf8IoQLlM8Ikq5c+I57YuinFkcyUA51/rijtZqV07OXVh14
  xf1JqRukRgv7eQtDU2sIDb8AKWwLypMdZr8qmklTxHfyynhSYOiR0MMk+leJashBuO
  sVserqCl9eofaZA4AYCrcYGVGnINxQpGhrK6UVJw=
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@pontorez.com>, <pontorez@pm.me>, <abuse@ovh.ca>
Subject: [eais#959860] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Fri, 8 Nov 2019 11:11:21 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://pontorez.com/lezginka .
