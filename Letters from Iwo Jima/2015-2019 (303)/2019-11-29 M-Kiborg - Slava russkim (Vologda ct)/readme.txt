Received: from mx1.rkn.gov.ru (mx1.rkn.gov.ru [87.226.213.147]) (using TLSv1.2 with
 ...
 mail15i.protonmail.ch (Postfix) with ESMTPS id 6D38F9B for <pontorez@pm.me>; Fri, 29 Nov
 2019 10:42:23 +0000 (UTC)
...
Authentication-Results: mail15i.protonmail.ch; dkim=pass (1024-bit key)
 header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="h+eHywlB"
X-Client-Proxied-By: ROSKOMNADZOR Secured Mail Server
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1575024137;
 bh=qbhpb+O3kueYF1fW/rbchfT67+yrlD4MDxKrPjpQgzU=; h=From:To:Subject:Date;
 b=h+eHywlBKY7JXHSrHHH8vjxtIIuDT4RCxE+GGowEYpAewjsYaxokBO1Uk7y6WGyLm
  +ZOwu9OjhKphFmFBf1+IHGR19vI/rvFFI5li78KA+jyWJHN99aC+k25PkC4r0R6esb
  S5H05CIhw2o3QZh4natZfEfrFQ4k3ecQ4TclTLt0=
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@pontorez.com>, <pontorez@pm.me>, <abuse@ovh.ca>
Subject: [eais#979127] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Fri, 29 Nov 2019 13:42:16 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: https://pontorez.com/cyborg-slava-russkim-1 .
