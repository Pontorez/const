Received: from mx1.rkn.gov.ru (mx1.rkn.gov.ru [87.226.213.147]) (using TLSv1.2 with
 ...
 mailin004.protonmail.ch (Postfix) with ESMTPS id B836C402CD21 for <pontorez@pm.me>; Thu,
 19 Dec 2019 14:00:49 +0000 (UTC)
...
Authentication-Results: mailin004.protonmail.ch; dkim=pass (1024-bit key)
 header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="mARs6WH3"
X-Client-Proxied-By: ROSKOMNADZOR Secured Mail Server
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1576764048;
 bh=meKkzMpRIjB4YGYmpLbkyWZBUwTY/zD2bxxUfWCx/Ro=; h=From:To:Subject:Date;
 b=mARs6WH3Wtrb4K30HpUFqU8a3QhvhpS+OAr0rvH7DsTtQ8rV3dYt3J6a6BvIxJrNF
  wmRZ32i+bgOL3kQaGRTLihQQ/sX89BsxO5DDzVn1ecNvlChgeWv4EYcGwe1D65QR+m
  NYQjg16yqQR+TbtLit5w6sMxQwV7THLqVGS4BlcA=
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@pontorez.com>, <pontorez@pm.me>, <abuse@ovh.ca>
Subject: [eais#994941] Роскомнадзор информирует/the Roscomnadzor is informing?B?aW5n?=
Mime-Version: 1.0
Content-Type: text/plain
Date: Thu, 19 Dec 2019 17:00:47 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/88 .
