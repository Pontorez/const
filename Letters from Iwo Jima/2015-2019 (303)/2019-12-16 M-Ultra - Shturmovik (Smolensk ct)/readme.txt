Received: from mx1.rkn.gov.ru (mx1.rkn.gov.ru [87.226.213.147]) (using TLSv1.2 with
 ...
 mailin004.protonmail.ch (Postfix) with ESMTPS id 175834010236 for <pontorez@pm.me>; Mon,
 16 Dec 2019 16:11:22 +0000 (UTC)
...
Authentication-Results: mailin004.protonmail.ch; dkim=pass (1024-bit key)
 header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="AYiwDFpT"
X-Client-Proxied-By: ROSKOMNADZOR Secured Mail Server
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1576512681;
 bh=PLM1/FyrpA93un3A5fxCUWGkbAD2NwAcGn3h6Qhh7F8=; h=From:To:Subject:Date;
 b=AYiwDFpTOqo3yAN5Q6NEDvVYsE0Qi4pUipaprEe0wY5Xyhygv6tK9wgHVjTesAXrR
  pwlXIqmZuVnet51VpnkUTAuWLx5NkBjQ60PiosVbI/N+uO0sEJJEbNqAgMqC+KGeKO
  h4k7CQl0nb7DTIBZ5bvsfYUpICdLZNExpcs7mp4s=
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@pontorez.com>, <pontorez@pm.me>, <abuse@ovh.ca>
Subject: [eais#991786] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Mon, 16 Dec 2019 19:11:20 +0300 (MSK)
