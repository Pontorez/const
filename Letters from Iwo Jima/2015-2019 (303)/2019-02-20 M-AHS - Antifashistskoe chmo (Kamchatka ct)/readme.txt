Received: from mx1.rkn.gov.ru ([87.226.213.147]:51968) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.91) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1gwP1b-00DyRY-M0 for pontorez@pontorez.com; Wed, 20 Feb
 2019 05:22:55 -0500
...
Subject: [eais#744769] Роскомнадзор информирует/the Roscomnadzor is informing
Date: Wed, 20 Feb 2019 13:22:04 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://pontorez.com/l/z_Ансамбль_Христа_Спасителя_-_Антифашистское_чмо.txt .
