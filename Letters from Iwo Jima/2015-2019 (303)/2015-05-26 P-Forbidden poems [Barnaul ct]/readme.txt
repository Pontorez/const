Received: from mx2.rkn.gov.ru ([188.254.8.82]:31183)
	by io.web-leader.net with esmtp (Exim 4.82)
	(envelope-from <zapret-info-out@rkn.gov.ru>)
	id 1YxCzz-001CRE-R6
	for pontorez@pontorez.com; Tue, 26 May 2015 07:26:22 -0400
X-Client-Proxied-By: ROSKOMNADZOR Secured Mail Server
From: Роскомнадзор <zapret-info-out@rsoc.ru>
To: <abuse@web-leader.net>, <pontorez@pontorez.com>, <abuse@ovh.ca>, <noc@ovh.net>
Subject: РОСКОМНАДЗОР информирует
Date: Tue, 26 May 2015 14:25:56 +0300

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www.pontorez.com/node/428 .
