Received: from mx1.rkn.gov.ru (mx1.rkn.gov.ru [87.226.213.147]) (using TLSv1.2 with
 ...
 mail20i.protonmail.ch (Postfix) with ESMTPS id 644EB83 for <pontorez@pm.me>; Fri, 22 Nov
 2019 14:30:40 +0000 (UTC)
...
Authentication-Results: mail20i.protonmail.ch; dkim=pass (1024-bit key)
 header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="BUL3FLLW"
X-Client-Proxied-By: ROSKOMNADZOR Secured Mail Server
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1574433039;
 bh=iyFIRzOPzklA3icwspCx1K6AXKZb2unndPl/7D8pLN4=; h=From:To:Subject:Date;
 b=BUL3FLLWiwz7lxI2GOl78R9OF0RYMf7FA3Yr08a7fxNA1QghzVWmaytWpMDC3FJ5I
  54OL3IQ5nvNb0F//LZQhW8qjBYUUQakE9WtotNw7jez00eUY9ngCNfC1DBNA1waGBI
  RXv3ZMA+2AURCmh7nWi+RWJEcxAfawOqR7ENncnM=
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@pontorez.com>, <pontorez@pm.me>, <abuse@ovh.ca>
Subject: [eais#972015] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Fri, 22 Nov 2019 17:30:38 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: https://pontorez.com/belaya-gvardiya-veteranov .
