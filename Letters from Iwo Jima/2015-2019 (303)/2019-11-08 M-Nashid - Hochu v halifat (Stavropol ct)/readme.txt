Received: from mx1.rkn.gov.ru (mx1.rkn.gov.ru [87.226.213.147]) (using TLSv1.2 with
 ...
 mail15i.protonmail.ch (Postfix) with ESMTPS id 5BB7B8B for <pontorez@pm.me>; Fri,
  8 Nov 2019 08:10:26 +0000 (UTC)
Authentication-Results: mail15i.protonmail.ch; dmarc=pass (p=quarantine dis=none)
...
Authentication-Results: mail15i.protonmail.ch; dkim=pass (1024-bit key)
 header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="IFJUI8/c"
X-Client-Proxied-By: ROSKOMNADZOR Secured Mail Server
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1573200619;
 bh=WZX0EM3ZlUVCUZGZ0hPU539eDQx+ydkM4qupz1rz0Zk=; h=From:To:Subject:Date;
 b=IFJUI8/cMqkVqhmXQM2R4eTsGYJLLExs32JKt3cV2d40MQ2PhHdIch2Rmm1RCzr9v
  3Ies9zkCucBA9XObuprIU8f7RYREAKxzGAcijRZl8QreDpFkb596sLJV2ucGF01GAN
  d8RLF08masEBCxcBGFto8plMvfXS70wmFubIKTXI=
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@pontorez.com>, <pontorez@pm.me>, <abuse@ovh.ca>, <abuse@ovh.ca>
Subject: [eais#959824] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Fri, 8 Nov 2019 11:10:19 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://pontorez.com/nashid-hochu-v-halifat .
