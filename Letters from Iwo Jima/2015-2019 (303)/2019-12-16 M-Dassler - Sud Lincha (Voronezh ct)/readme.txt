Received: from mx1.rkn.gov.ru (mx1.rkn.gov.ru [87.226.213.147]) (using TLSv1.2 with
 ...
 mail17i.protonmail.ch (Postfix) with ESMTPS id 63D193000079 for <pontorez@pm.me>; Mon,
 16 Dec 2019 16:10:53 +0000 (UTC)
...
Authentication-Results: mail17i.protonmail.ch; dkim=pass (1024-bit key)
 header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="pCnFqvaj"
X-Client-Proxied-By: ROSKOMNADZOR Secured Mail Server
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1576512652;
 bh=uM0JhxEnLbz+nzyXYZNxu1Mn8T9QH6FsfhRZyfdpfV0=; h=From:To:Subject:Date;
 b=pCnFqvajFbRBH6BPGowAd49/Rb5/TxJn04ERTdRAh0QUurKB1dc5H3qSP9yjuGMSa
  KLoTt85o//ZGprr8+dWmB6Zwoxpg/vUC1z8sh32ZP0Pw3bIQmBh+k8gqYlkW57it0g
  t96v8SrNJz+MiTDXTimGldtF+tLh471xuS1qDrq8=
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@pontorez.com>, <pontorez@pm.me>, <abuse@ovh.ca>
Subject: [eais#991737] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Mon, 16 Dec 2019 19:10:52 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/dassler-sud-lincha .
