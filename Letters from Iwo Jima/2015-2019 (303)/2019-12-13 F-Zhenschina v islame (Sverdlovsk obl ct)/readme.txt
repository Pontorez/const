Received: from mx1.rkn.gov.ru (mx1.rkn.gov.ru [87.226.213.147]) (using TLSv1.2 with
 ...
 mail17i.protonmail.ch (Postfix) with ESMTPS id 738463003504 for <pontorez@pm.me>; Fri,
 13 Dec 2019 11:00:17 +0000 (UTC)
...
Authentication-Results: mail17i.protonmail.ch; dkim=pass (1024-bit key)
 header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="S8T0CpX8"
X-Client-Proxied-By: ROSKOMNADZOR Secured Mail Server
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1576234810;
 bh=u/n7SDBOSUWvP+yS8qV9+Ac1cdLy42n0H2YO8M0NrMY=; h=From:To:Subject:Date;
 b=S8T0CpX8h1irwHWytBP4uZeUUnGQZ3sYWsvUmlPLeW6L3WCWuzWhO3dmKKhNCJWh4
  OmRz9nx8NQPInbCKpB0n6U0yRldO3ECvwyKiaiW5M48/GEdmbI7na0Aj92N+VuDMhz
  Na0eHZXiB0qZ0cjS2zAAIgeKZkcfqVuVmZADFnuo=
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@pontorez.com>, <pontorez@pm.me>, <abuse@ovh.ca>
Subject: [eais#990584] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Fri, 13 Dec 2019 14:00:09 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/_/books/woman-in-islam.pdf .
