Received: from mx1.rkn.gov.ru ([87.226.213.147]:60986) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1hpV9m-008Flv-AB for pontorez@pontorez.com; Mon, 22 Jul
 2019 06:03:06 -0400
...
Subject: [eais#870712] Роскомнадзор информирует/the Roscomnadzor is informing
Date: Mon, 22 Jul 2019 13:02:16 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://pontorez.com/1/z_Ансамбль_Христа_Спасителя_-_И_вновь_загремит_бухенвальдский_набат.txt .
