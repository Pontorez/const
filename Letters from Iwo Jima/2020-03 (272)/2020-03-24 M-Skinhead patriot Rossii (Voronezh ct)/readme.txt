Received: from mx1.rkn.gov.ru (mx1.rsoc.ru [87.226.213.147]) (using TLSv1.2 with cipher
 ...
 mailin006.protonmail.ch (Postfix) with ESMTPS id 3070D4010081 for <pontorez@pm.me>; Tue,
 24 Mar 2020 20:10:16 +0000 (UTC)
...
Authentication-Results: mailin006.protonmail.ch; dkim=pass (1024-bit key)
 header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="rVacU0f8"
X-Client-Proxied-By: ROSKOMNADZOR Secured Mail Server
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1585080615;
 bh=ENF+I3ZpSRqGpH1n7qTTymbZ+NYOa7XmcrwrKUq4o9U=; h=From:To:Subject:Date;
 b=rVacU0f8rCJ2UJTsRv8CLIjLrc4ngVa474bNbpOCwMm8Mtd059DuuGQha5Y02hVec
  OGVbbNJxK6A/K1Ix6DElX+HrWAcNEwYqMhra9W1wY9i5yW1fvqWLam0uDy8gGtyjd0
  IFBCGyCrwt82C8YXlXKpKNlV6BjZiSPr8eEt2E+Y=
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@pontorez.com>, <pontorez@pm.me>, <abuse@ovh.ca>
Subject: [eais#1071763] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Tue, 24 Mar 2020 23:10:15 +0300 (MSK)
