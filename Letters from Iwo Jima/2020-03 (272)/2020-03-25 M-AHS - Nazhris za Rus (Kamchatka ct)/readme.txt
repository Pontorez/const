Received: from mx1.rkn.gov.ru (mx1.rkn.gov.ru [87.226.213.147]) (using TLSv1.2 with
 cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits)) (No client certificate requested) by
 mailin004.protonmail.ch (Postfix) with ESMTPS id 9522E401009E for <pontorez@pm.me>; Wed,
 25 Mar 2020 18:58:07 +0000 (UTC)
...
Authentication-Results: mailin004.protonmail.ch; spf=pass
 smtp.mailfrom=zapret-info-out@rkn.gov.ru
Authentication-Results: mailin004.protonmail.ch; dkim=pass (1024-bit key)
 header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="XEskoXrN"
X-Client-Proxied-By: ROSKOMNADZOR Secured Mail Server
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1585162686;
 bh=2Bjy+vqZJ2uKRutaDVh4acbLkjTsA4Zpwn7q/fUtT4I=; h=From:To:Subject:Date;
 b=XEskoXrNUe6gwfzL3Y7ELGFFOuQK6Oy+OFyjQaxR9mdgTvuzEav0Oasrx6F+0gIqv
  fF5zGBjqLEsNd3Zw2oWoe/l/gU3A0ZGpAWJzidnXFUGVDdCMk9YDbK+SqW3jhHO8lF
  7SBLWZiSp61+iyGhV3YNv9ageYYrfQAOQaKgv5oo=
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@pontorez.com>, <pontorez@pm.me>, <abuse@ovh.ca>, <abuse@ovh.ca>,
 <abuse@ovh.ca>
Subject: [eais#1072753] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Wed, 25 Mar 2020 21:58:05 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/ansambl.hrista.spasitelya.najris.za.rus .
