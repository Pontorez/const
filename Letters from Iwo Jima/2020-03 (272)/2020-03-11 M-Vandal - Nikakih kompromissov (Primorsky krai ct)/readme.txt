Received: from mx1.rkn.gov.ru (mx1.rsoc.ru [87.226.213.147]) (using TLSv1.2 with cipher
 ...
 mailin015.protonmail.ch (Postfix) with ESMTPS id AD749300024F for <pontorez@pm.me>; Wed,
 11 Mar 2020 18:39:32 +0000 (UTC)
...
Authentication-Results: mailin015.protonmail.ch; dkim=pass (1024-bit key)
 header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="MaKqa+EW"
X-Client-Proxied-By: ROSKOMNADZOR Secured Mail Server
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1583951971;
 bh=XRrkOw/6ZpsWzmHcOjVP8UBWsF/lK2Jweas3hKBhUMA=; h=From:To:Subject:Date;
 b=MaKqa+EWw6QHeWgeJFSDZuy3Xv8RBLje/CSLXAukRNc3LKCm0KuOEh+6E3xSi8vE8
  Rjqk4zVg3pFQ3RcBpOKiSkscN0/RVSxZH7xpOjXA8TQevk/UcbwvhKiRdLzZOl96ud
  R9qWk64uN2C2HcoxpoAmBChREvabBtrpF/zcrx9Q=
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@pontorez.com>, <pontorez@pm.me>, <abuse@ovh.ca>
Subject: [eais#1059365] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Wed, 11 Mar 2020 21:39:30 +0300 (MSK)
