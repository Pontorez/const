Received: from mx1.rkn.gov.ru (mx1.rkn.gov.ru [87.226.213.147]) (using TLSv1.2 with
 ...
 mailin008.protonmail.ch (Postfix) with ESMTPS id 538AE300027E for <pontorez@pm.me>; Wed,
 18 Mar 2020 16:11:28 +0000 (UTC)
...
Authentication-Results: mailin008.protonmail.ch; dkim=pass (1024-bit key)
 header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="FbBPEKRX"
X-Client-Proxied-By: ROSKOMNADZOR Secured Mail Server
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1584547887;
 bh=ouPOmbTeML5l5ZgMrZtgbHqmx5o6STG1Wr/KPcLhguk=; h=From:To:Subject:Date;
 b=FbBPEKRXvZseRif8VUa6QBvTC8SNu5+OgWcfVcw+D/3kZxDNxJ+oTcjc6u0AhU4IA
  gP5lOxdpP1Shqr6DzcFzQyq1wL6vF8SsuVSaoArzUoNL3oA6B6aNZHpFbL+X+K3M2q
  0tc/n2BtE96RTF4jZj2hYjvMSFFZwEo+q0SWfViU=
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@pontorez.com>, <pontorez@pm.me>, <abuse@ovh.ca>
Subject: [eais#1066470] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Wed, 18 Mar 2020 19:11:26 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/ansambl.hrista.spasitelya.i.vnov.zagremit .
