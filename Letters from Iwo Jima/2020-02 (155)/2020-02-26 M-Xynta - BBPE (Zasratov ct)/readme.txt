Received: from mx1.rkn.gov.ru (mx1.rkn.gov.ru [87.226.213.147]) (using TLSv1.2 with
 ...
 mailin008.protonmail.ch (Postfix) with ESMTPS id C3DFA3000243 for <pontorez@pm.me>; Wed,
 26 Feb 2020 15:59:16 +0000 (UTC)
...
Authentication-Results: mailin008.protonmail.ch; dkim=pass (1024-bit key)
 header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="XuM04tPT"
X-Client-Proxied-By: ROSKOMNADZOR Secured Mail Server
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1582732756;
 bh=RxpoFOGqeTZw0PPPfmJL433uTijYHqL/KIoLNA3+1Pw=; h=From:To:Subject:Date;
 b=XuM04tPTCWgSrtlwFKKiK4yVma6vPKHnJj1P5QI0CmdHnV5eTxl4ZHR/ICP5UovS0
  7aFgUM0w6YuIHPS2L5KSbPHorYyhdHP/9nM5yxMH0aQE7oncX/idZSy4/NdcX08Itp
  RaCu3un7SIj2upHSviAkLNi8ipqAepxrip5n+dJg=
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@pontorez.com>, <pontorez@pm.me>, <abuse@ovh.ca>
Subject: [eais#1046684] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Wed, 26 Feb 2020 18:59:15 +0300 (MSK)
