Received: from mx1.rkn.gov.ru (mx1.rsoc.ru [87.226.213.147]) (using TLSv1.2 with cipher
 ...
 mailin008.protonmail.ch (Postfix) with ESMTPS id 5E6C63000266 for <pontorez@pm.me>; Mon,
  3 Feb 2020 17:46:39 +0000 (UTC)
...
Authentication-Results: mailin008.protonmail.ch; dkim=pass (1024-bit key)
 header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="fSr3HK/q"
X-Client-Proxied-By: ROSKOMNADZOR Secured Mail Server
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1580751993;
 bh=nyCTM38KgfEQXcaJLROcpXipAG0HS2n8XYyvbXitB3Y=; h=From:To:Subject:Date;
 b=fSr3HK/qHViHqIK5rxEOFaDgE9kxuGpdykKBHmH/Lvj3wgl1/wQ/bC2i1hDUh29lC
  yvlrJz1/jpESgnshi5K9AVLMQhHCHm+HELSw8b6mAIYN4+ZpW4DPFb5PIr6iuLI/i5
  0OzueF/q9KWmRCbpRV7FMLkW+QEXueyA7MJS0wdU=
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@pontorez.com>, <pontorez@pm.me>, <abuse@ovh.ca>
Subject: [eais#1028426] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Mon, 3 Feb 2020 20:46:32 +0300 (MSK)
