Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin004.protonmail.ch (Postfix) with ESMTP id 83BCE401008A for
 <pontorez@protonmail.ch>; Mon,
  6 Apr 2020 10:15:12 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id C23BB809A9 for
 <pontorez@protonmail.ch>; Mon,
  6 Apr 2020 13:11:19 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:40564) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jLOFJ-001QyT-Kj for pontorez@pontorez.com; Mon, 06 Apr
 2020 05:40:54 -0400
...
Authentication-Results: mailin004.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="MTFi1Eus"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="MUcZj5cJ"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=TlR+ph9ID+Yhlqd5JlqlpprCYYXUARvv6sB7LAdivxs=; b=MTFi1Eus6WFiEOODMqYSsy69Jd
  MAoAEczQ==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1586166003;
 bh=TlR+ph9ID+Yhlqd5JlqlpprCYYXUARvv6sB7LAdivxs=; h=From:To:Subject:Date;
 b=MUcZj5cJenEkYVZcs+Pf4Pf+CnI62c0YAwqw/nk+wVzuXJUNVU8lVCoqntQC0J4PT
  KfOzK7i63/lIvJxDhidedd4wSTOb4X7+2kWYrMGlZ6bTMLxsxRn/K8B8Vdg1Jx2Yl3
  fl/gbUxPF0mxMbQUuDCqI+YBS5Ppab9qqWEuHDtk=
...
Subject: [eais#1077526] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Mon, 6 Apr 2020 12:40:03 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/molotov-coctail .
