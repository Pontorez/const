Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin008.protonmail.ch (Postfix) with ESMTP id 594513003ED0 for
 <pontorez@protonmail.ch>; Tue, 14 Apr 2020 16:16:29 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 62F8482721 for
 <pontorez@protonmail.ch>; Tue, 14 Apr 2020 19:16:21 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:55532) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jOOEK-001J58-40 for pontorez@pontorez.com; Tue, 14 Apr
 2020 12:16:20 -0400
...
Authentication-Results: mailin008.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="XBE2dw+0"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="Gz6wcVMl"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=R0y384UVztGoWA6YMlFl7BgT6385CFik/qGh0KWjHwg=; b=XBE2dw+0bN3YmCc34iBGlHD/yx
  ZRPCUO0w==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1586880926;
 bh=R0y384UVztGoWA6YMlFl7BgT6385CFik/qGh0KWjHwg=; h=From:To:Subject:Date;
 b=Gz6wcVMlCf7RJcFnWkhGIlArflfcY6l+kSRtBzOpttVo7nQmPMlf9LBHF98ky+PmD
  /Uoy31EVMCIV0TGbAF+heka2WUwo6AXQZJAcw93YeJ8DkCRxn/eZo/vc49n+BnRoRu
  xgPv7RlaYsOQAeqXnFt5cQPVVSa3HsJMbgG7sid8=
...
Subject: [eais#1093213] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Tue, 14 Apr 2020 19:15:26 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/timur_mutsuraev-12000_modzhahedov .
