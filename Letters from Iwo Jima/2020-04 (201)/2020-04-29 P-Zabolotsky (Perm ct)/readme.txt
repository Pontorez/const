Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin008.protonmail.ch (Postfix) with ESMTP id 6F647300024F for
 <pontorez@protonmail.ch>; Wed, 29 Apr 2020 16:01:29 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 358D882757 for
 <pontorez@protonmail.ch>; Wed, 29 Apr 2020 18:57:59 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:43390) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jTp5A-00Du6Z-9M for pontorez@pontorez.com; Wed, 29 Apr
 2020 11:57:18 -0400
...
Authentication-Results: mailin008.protonmail.ch; spf=pass
 smtp.mailfrom=SRS0=VZju9m=6N=rkn.gov.ru=zapret-info-out@pontorez.com
Authentication-Results: mailin008.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="QYzMeRbt"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="ZpOejZVR"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=7Xz3Clv2oYzBl1Pd9plvEqA7AEmKQDLavF58Gen60kw=; b=QYzMeRbtJEWe9qT7sHybSwBWoI
  VkYTWgQA==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1588175739;
 bh=7Xz3Clv2oYzBl1Pd9plvEqA7AEmKQDLavF58Gen60kw=; h=From:To:Subject:Date;
 b=ZpOejZVRev9P+ofUnEqZ2N3d2kE6PeOmmJUa3Tgfd+eHXOnXIaqBL1vK0BKnwQMng
  hx5R6buAEjx+B8NmaX8NSwF1uGKCVsgYEERddn9NtPuh2SpwLaVETahCnZUZuHMq4x
  mQDwo2PQ701Ll+wmqhE+aXJu6SYyR+oqWyKAxjB4=
...
Subject: [eais#1108414] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Wed, 29 Apr 2020 18:55:38 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/zabolotsky .
