Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin011.protonmail.ch (Postfix) with ESMTP id B92334010AA7 for
 <pontorez@protonmail.ch>; Tue,
  7 Apr 2020 15:03:32 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 95FF7816DC for
 <pontorez@protonmail.ch>; Tue,
  7 Apr 2020 18:02:30 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:54374) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jLpdg-00Bsxl-EA for pontorez@pontorez.com; Tue, 07 Apr
 2020 10:55:51 -0400
...
Authentication-Results: mailin011.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="XyQp9faX"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="OVI+lM0g"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=d3xlCZf3hjTYqgvtdgg8b66GxM4IMUacO6D0EY/tNio=; b=XyQp9faXZa2XfRxoOCEjAvLRzU
  uK23AARQ==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1586271303;
 bh=d3xlCZf3hjTYqgvtdgg8b66GxM4IMUacO6D0EY/tNio=; h=From:To:Subject:Date;
 b=OVI+lM0gcaQXC1Skf7eHWdp5oAYMTx4MLDaH8jE1j++jpOPjV6OU34fExDfAGH2Uw
  3IJnHPPAKbiPUvSVVeWu8mxTfz0EiHxoSSNIiS4KS+FBKnf1NftIUBsqftdJvFKrID
  A8HmmsfNF+7HZTCh7wxobravN/oPxYxNOC+V9V1A=
...
Subject: [eais#1085475] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Tue, 7 Apr 2020 17:55:03 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: https://www2.pontorez.com/vandal-na-shturm .
