Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin012.protonmail.ch (Postfix) with ESMTP id 80DD84010089 for
 <pontorez@protonmail.ch>; Thu, 16 Apr 2020 16:29:46 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 8A95E82721 for
 <pontorez@protonmail.ch>; Thu, 16 Apr 2020 19:29:38 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:42644) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jP6yn-00ApAI-Ph for pontorez@pontorez.com; Thu, 16 Apr
 2020 12:03:17 -0400
...
Authentication-Results: mailin012.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="UNXJiS1a"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="CFA+CBwo"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=zQ0xy9m5IOAovQKFcGTqQvb5UJPlvPnNbvn7LxJXi0E=; b=UNXJiS1aLG4tfrSimCsjRuY25Q
  0kW/dlnA==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1587052530;
 bh=zQ0xy9m5IOAovQKFcGTqQvb5UJPlvPnNbvn7LxJXi0E=; h=From:To:Subject:Date;
 b=CFA+CBwo24Tib1Nw9b9nHy/oAMMtK+Ie9Go+W57c7O7lF76CyFvp6VHjUct6huKY/
  ucD7ldq1vW4lU7OF/hy/QeknrD/7L+8TiGUN6konpgHbLpKSDoRDaIQohNsezVIyNk
  k61+yef/nr2T//jpPC3Bh2LNxeE0dVTFAvLHtF0A=
...
Subject: [eais#1096012] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Thu, 16 Apr 2020 18:55:30 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/calvados_primates .
