Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin006.protonmail.ch (Postfix) with ESMTP id 8E8CC401007A for
 <pontorez@protonmail.ch>; Wed, 15 Apr 2020 14:36:47 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 98971809A9 for
 <pontorez@protonmail.ch>; Wed, 15 Apr 2020 17:36:45 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:60760) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jOj8t-005u2c-Mk for pontorez@pontorez.com; Wed, 15 Apr
 2020 10:36:44 -0400
Authentication-Results: mailin006.protonmail.ch; dmarc=pass (p=quarantine dis=none)
...
Authentication-Results: mailin006.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="cKf4T0pI"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="dHS+TBQA"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=nga/Z8DSflAlbrhax1Mqe+0h3Fh46TCstCQntRC0v9M=; b=cKf4T0pIcQptBAZCUuBgvqYqs1
  ZPRt3w/Q==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1586961314;
 bh=nga/Z8DSflAlbrhax1Mqe+0h3Fh46TCstCQntRC0v9M=; h=From:To:Subject:Date;
 b=dHS+TBQAtApCuVlo+n7/9GWPF9niVlAAtxSIpyovHmf0ER8Llva6RZxA2coKsfJVZ
  sz37e7QCeLeoJMscZSh9q4XaUPTxnAj6NbvEFalE5N8hTcTK7d2IJ8Y1zwyW1gMPrv
  AH17xZuMGdYFcfLakDDCm793OIMeoQAayj8CnhQM=
...
Subject: [eais#1094702] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Wed, 15 Apr 2020 17:35:14 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/russkoe_getto.zheltaya.ugroza .
