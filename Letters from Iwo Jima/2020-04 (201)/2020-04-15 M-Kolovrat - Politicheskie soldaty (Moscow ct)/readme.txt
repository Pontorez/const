Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin006.protonmail.ch (Postfix) with ESMTP id 6C576401009A for
 <pontorez@protonmail.ch>; Wed, 15 Apr 2020 14:29:58 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 850DE82743 for
 <pontorez@protonmail.ch>; Wed, 15 Apr 2020 17:29:50 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:59138) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jOj2l-005t8M-1V for pontorez@pontorez.com; Wed, 15 Apr
 2020 10:29:49 -0400
...
Authentication-Results: mailin006.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="f9GiAvKK"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="Pogt5cFi"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=esCWWZRwzi+SnwndAoh2JPLxudbAaQej/mdanDbH5kI=; b=f9GiAvKKHYaphovWyw7J0xI7at
  ofrExg6Q==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1586960932;
 bh=esCWWZRwzi+SnwndAoh2JPLxudbAaQej/mdanDbH5kI=; h=From:To:Subject:Date;
 b=Pogt5cFicKKdu36gxX+PuAFpph3+sxPnIZNpTIkoWiPnGh/tZRNi7oT66QiFFN8Gs
  cjBQ4bAo5PlpV7UAyi1OPDf+FaUBlHU18sdN8qnVrOmb1gNPvQI1Mm42UpzFKll6p+
  T+2IyXgH6aeH5TDSUvHkFKaOKsJgtowilfvTRQMA=
...
Subject: [eais#1093860] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Wed, 15 Apr 2020 17:28:52 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/soldiers .
