Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin012.protonmail.ch (Postfix) with ESMTP id E5DB44010080 for
 <pontorez@protonmail.ch>; Fri, 17 Apr 2020 12:53:03 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id BEC6D81007 for
 <pontorez@protonmail.ch>; Fri, 17 Apr 2020 15:53:01 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:40058) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jPQUF-00F6sG-Pm for pontorez@pontorez.com; Fri, 17 Apr
 2020 08:53:00 -0400
...
Authentication-Results: mailin012.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="dzVWMzG9"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="LCb/8NgH"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=++xPwhYbz3fCSQxnkkg+3PqunWkg7AevPfgnxsV3QwE=; b=dzVWMzG9n5wLzLsBmW591n3o4C
  OV1S2Q8g==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1587127878;
 bh=++xPwhYbz3fCSQxnkkg+3PqunWkg7AevPfgnxsV3QwE=; h=From:To:Subject:Date;
 b=LCb/8NgHo938sLzZSmrioEY3hkrstncfI1vagiDVS5upejEaG349CN8qtSFpqXUt+
  C+VK5dv0XLqqFQDMJVl+BuHVz2fUgU8ycEC5CmjSw+0QNYmIwCQTo9opptwHjPjE6C
  Fzovj4r67UoJXZAmHRfx3qbhMVV73KVzTis0k2PY=
...
Subject: [eais#1096819] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Fri, 17 Apr 2020 15:51:18 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/uteshitelny-priz .
