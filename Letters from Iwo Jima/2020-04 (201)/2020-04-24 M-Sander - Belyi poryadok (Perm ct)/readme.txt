Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin004.protonmail.ch (Postfix) with ESMTP id 84D7D4010087 for
 <pontorez@protonmail.ch>; Fri, 24 Apr 2020 14:08:23 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 399A180C5A for
 <pontorez@protonmail.ch>; Fri, 24 Apr 2020 17:05:31 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:33194) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jRyPs-00Gy08-IK for pontorez@pontorez.com; Fri, 24 Apr
 2020 09:30:59 -0400
...
Authentication-Results: mailin004.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="UwN84I9g"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="VnrPQXH0"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=0pOxR3QmZFl8OVCqfPsKORJTEbyo1Cmn8E9MHuo/TyU=; b=UwN84I9gpsmUj0PIlx3bRimQR+
  uhHeAWjQ==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1587735011;
 bh=0pOxR3QmZFl8OVCqfPsKORJTEbyo1Cmn8E9MHuo/TyU=; h=From:To:Subject:Date;
 b=VnrPQXH0bd5MMaEeOVG0wkdIkB7toqVWm/V32r32GPKE0AzuyzeL8SjaNMkU7Cgdu
  7smWC8C4hlmagJF7vd7fr6d0wrHpNmuMt5TelLJu9Bk2aDhVsvvW7lqtQDIP6Cy2gt
  lkKMx231TNQC0ugNmf/ui1F1hTZ+TmgLtMGVLm98=
...
Subject: [eais#1103785] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Fri, 24 Apr 2020 16:30:11 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/sander-belyi-poryadok .
