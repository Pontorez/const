Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin012.protonmail.ch (Postfix) with ESMTP id 4A07C4010082 for
 <pontorez@protonmail.ch>; Fri, 17 Apr 2020 14:11:04 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id B57A181007 for
 <pontorez@protonmail.ch>; Fri, 17 Apr 2020 17:11:01 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:44278) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jPRhl-00FMtY-3l for pontorez@pontorez.com; Fri, 17 Apr
 2020 10:11:00 -0400
...
Authentication-Results: mailin012.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="EoNmePRU"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="qmtIPLma"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=ugfD72yEgF2baXiG+8O1qWZxKXlH+bUUklGBvXg343o=; b=EoNmePRUamFtDWJ6lyuFjOIDfz
  jfVif6NQ==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1587132611;
 bh=ugfD72yEgF2baXiG+8O1qWZxKXlH+bUUklGBvXg343o=; h=From:To:Subject:Date;
 b=qmtIPLmaK1RgaIeG4RYDqRt6wVJ5uUXSbZ+shpxxDhDpRVOxOi2lh+epGkxHd3pI8
  WfpVvQFQneSRXn4FMRRdQbueSAurSZjAVU2SYUyBBJsgsvvLO8zNdxiiIYkmQycnDY
  i5Sqq6CZqxX/d1SVO8TUXxQfNJobl2adq6yFp1DQ=
...
Subject: [eais#1097238] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Fri, 17 Apr 2020 17:10:11 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: https://www2.pontorez.com/nashid-hochu.v.halifat .
