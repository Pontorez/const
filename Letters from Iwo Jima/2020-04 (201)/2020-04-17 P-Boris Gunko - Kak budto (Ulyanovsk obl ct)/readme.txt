Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin008.protonmail.ch (Postfix) with ESMTP id 5CAE93000246 for
 <pontorez@protonmail.ch>; Fri, 17 Apr 2020 12:52:59 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 1A94D81007 for
 <pontorez@protonmail.ch>; Fri, 17 Apr 2020 15:52:52 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:39466) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jPQTN-00F6is-U9 for pontorez@pontorez.com; Fri, 17 Apr
 2020 08:52:50 -0400
...
Authentication-Results: mailin008.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="ERUOGtRe"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="T+C+joLs"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=KqRPpqLQAG/RzlTwM5Cb/KSSyT59wSybpshGYMR9NzQ=; b=ERUOGtRe+vLFuOfgGlZYGZmjtM
  ccPVVr9g==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1587127875;
 bh=KqRPpqLQAG/RzlTwM5Cb/KSSyT59wSybpshGYMR9NzQ=; h=From:To:Subject:Date;
 b=T+C+joLsUuP4ofv182NXwUh3JPhq5WHnvoOo0ojdx7jqhj+uVHFjX8WE/5Hpz35jp
  w1+1wxNi71R3NsUdJqcKdY2nbjFcofTunoAbu5O4vxdwSBblilRYU5yUP8mocQ81ky
  o73PzgngyhfhpytVRT++H3Ohau+OZiIRV5rCvwTo=
