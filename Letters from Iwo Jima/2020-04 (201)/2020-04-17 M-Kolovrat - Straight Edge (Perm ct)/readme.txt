Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin006.protonmail.ch (Postfix) with ESMTP id 4437F401008C for
 <pontorez@protonmail.ch>; Fri, 17 Apr 2020 12:57:14 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 5B5B183BDB for
 <pontorez@protonmail.ch>; Fri, 17 Apr 2020 15:54:29 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:40098) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jPQV4-00F765-4t for pontorez@pontorez.com; Fri, 17 Apr
 2020 08:53:53 -0400
...
Authentication-Results: mailin006.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="F1lUpPkk"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="JVX88nTj"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=fZjax2SsqiDtkveGY32/xRQijlSJxYM6xIRqGGQlbPA=; b=F1lUpPkkEB8KuadwfeEjIs/78/
  a46i+jKg==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1587127883;
 bh=fZjax2SsqiDtkveGY32/xRQijlSJxYM6xIRqGGQlbPA=; h=From:To:Subject:Date;
 b=JVX88nTjDAoHK6Ol0Aj3CeHWgZs33aDgGy6hJy0OnOTGMJS2XVx0e3n5MnnTkTt7l
  XtLOyIJoRwX5XnTb+kJLrFkcYyzTbDHkG0sijgegLRe5UviMVOWnTL1JS/PemcSWP9
  ZMuJyf4wiN08FiwMtdWuHYeOlQEYmeo2HQmxnmpk=
...
Subject: [eais#1096842] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Fri, 17 Apr 2020 15:51:23 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/kolovrat_straight-edge .
