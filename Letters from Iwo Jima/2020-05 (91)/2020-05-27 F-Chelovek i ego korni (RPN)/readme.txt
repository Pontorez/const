Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin004.protonmail.ch (Postfix) with ESMTP id C79644010097 for
 <pontorez@protonmail.ch>; Wed, 27 May 2020 09:03:52 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 033928171A for
 <pontorez@protonmail.ch>; Wed, 27 May 2020 12:03:17 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:60106) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jdrxq-00B8KE-LP for pontorez@pontorez.com; Wed, 27 May
 2020 05:03:15 -0400
...
Authentication-Results: mailin004.protonmail.ch; spf=pass
 smtp.mailfrom=SRS0=JDE2OE=7J=rkn.gov.ru=zapret-info-out@pontorez.com
Authentication-Results: mailin004.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="geJInD6M"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="nczgffTY"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=uGrhWnJhjYLBDF3fAfvA830iQvzsabfKPZVOhnoibic=; b=geJInD6MiDoPkGpeQEtkh018Lq
  stkupwJw==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1590569768;
 bh=uGrhWnJhjYLBDF3fAfvA830iQvzsabfKPZVOhnoibic=; h=From:To:Subject:Date;
 b=nczgffTYinBxXbguLhLt+KCe9zovb5jRoBHwKeW6PojimHVojZvxMnrzK35IipkRy
  ByzQlST0lRo/fu1nRK+CJGxGgJqFQbJFkyOz/V5binz212FhVDnkZtd06pOOjL9cwM
  cRohxkxGmyiI4cvluHXKKGCOP8nGGPR5pNloRUzo=
...
Subject: [eais#1092653] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Wed, 27 May 2020 11:56:08 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/chelovek-i-ego-korni .
