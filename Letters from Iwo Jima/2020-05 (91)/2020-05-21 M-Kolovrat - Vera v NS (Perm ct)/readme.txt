Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin006.protonmail.ch (Postfix) with ESMTP id 505BB4010090 for
 <pontorez@protonmail.ch>; Thu, 21 May 2020 16:33:44 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id B94F180869 for
 <pontorez@protonmail.ch>; Thu, 21 May 2020 19:32:57 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:54942) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jbo7h-00Arv1-5O for pontorez@pontorez.com; Thu, 21 May
 2020 12:32:53 -0400
...
Authentication-Results: mailin006.protonmail.ch; spf=pass
 smtp.mailfrom=SRS0=4tSIhN=7D=rkn.gov.ru=zapret-info-out@pontorez.com
Authentication-Results: mailin006.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="WVe2uvsL"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="qZE5Vbxi"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=s1ypLYJvWVba0kEP+DTRqqAgxn8jg7HPJKmDEvaCKFk=; b=WVe2uvsLCdO31h8mTn7k3appN3
  fXkwvrvA==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1590078309;
 bh=s1ypLYJvWVba0kEP+DTRqqAgxn8jg7HPJKmDEvaCKFk=; h=From:To:Subject:Date;
 b=qZE5VbxiOA5D8IWEVYXB4n4zvJYHRKVlyEmIR/vjOXpj7poC3+QsV1xAGyBxBd3YE
  rfM3KimXnTahn6fNZTlcwe2b2boGDxg3ZdTz79pIOIYzYpo/QUBmQNlUAVC/t91Iwp
  Ljz3ibCM/ecAlLRhc5Sfhho1PN4IdeShKM8Gt4lM=
...
Subject: [eais#1125096] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Thu, 21 May 2020 19:25:09 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: https://www2.pontorez.com/kolovrat_vera-v-ns .
