Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin015.protonmail.ch (Postfix) with ESMTP id E8EFE300024D for
 <pontorez@protonmail.ch>; Tue, 12 May 2020 13:13:53 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 7FED4808A1 for
 <pontorez@protonmail.ch>; Tue, 12 May 2020 16:10:58 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:50264) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jYTJB-002fW0-EI for pontorez@pontorez.com; Tue, 12 May
 2020 07:42:57 -0400
...
Authentication-Results: mailin015.protonmail.ch; spf=pass
 smtp.mailfrom=SRS0=w1VXax=62=rkn.gov.ru=zapret-info-out@pontorez.com
Authentication-Results: mailin015.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="VhYq64Im"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="IJ+f+nKj"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=43EiH2U1hs2YDXz4CNrHeUTyB+meCQGdMIIactz6HL4=; b=VhYq64Imrq9rhlPIUYSQdcHaxi
  HYbAjNEA==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1589283308;
 bh=43EiH2U1hs2YDXz4CNrHeUTyB+meCQGdMIIactz6HL4=; h=From:To:Subject:Date;
 b=IJ+f+nKjf8g1zN8rE9vKZxHV0D7YYJpTdWsqAJSQIWcBZjdXBccU3ciIPg+aMUtgi
  in6KirfDEjDt4GuQ86PLkhMZeDF9PDl9HJlk20Kr0qzOfOd7S9sOvO4CHTiNcrEiUW
  tFiUz3n8GGclSvQI0vciby7VbZVc6KRvl1kU0oJQ=
...
Subject: [eais#1114999] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Tue, 12 May 2020 14:35:08 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/ciklon-b-deti-gor .
