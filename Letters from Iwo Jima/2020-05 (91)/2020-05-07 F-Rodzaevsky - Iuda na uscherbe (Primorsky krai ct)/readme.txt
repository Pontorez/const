Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin011.protonmail.ch (Postfix) with ESMTP id AA93B401008D for
 <pontorez@protonmail.ch>; Thu,
  7 May 2020 14:55:41 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id ADE7481658 for
 <pontorez@protonmail.ch>; Thu,
  7 May 2020 17:44:44 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:38070) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jWhhu-00CvlE-4U for pontorez@pontorez.com; Thu, 07 May
 2020 10:41:10 -0400
...
Authentication-Results: mailin011.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="OS6ss0S7"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="mGanParn"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=z5W2IQhRp7WXNYnM/xyCdjq16ioCmX6+tY9V4gTsivE=; b=OS6ss0S7a+Vh/7703HDizMWLBq
  Mlvrz4hg==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1588862420;
 bh=z5W2IQhRp7WXNYnM/xyCdjq16ioCmX6+tY9V4gTsivE=; h=From:To:Subject:Date;
 b=mGanParn1yFQT1rO9BbU3i/JUsa+zup1Qbx94U6fFH6xnyqduhGjm/gbRr1IjBSvK
  rozXmhjGahw1RogXJ98UVhml3E7nMEpjRhzaBOHKCXxToBFSphGsTGXIIMwcYkSUhP
  10zGYxJ9wdn2SWHbLFzF0TjuQLsE+C9yAXTWJdd8=
...
Subject: [eais#1112962] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Thu, 7 May 2020 17:40:20 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/konstantin-rodzaevsky-iuda-na-uscherbe .
