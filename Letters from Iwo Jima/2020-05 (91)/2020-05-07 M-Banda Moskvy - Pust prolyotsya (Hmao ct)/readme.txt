Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin012.protonmail.ch (Postfix) with ESMTP id 7BA08401008A for
 <pontorez@protonmail.ch>; Thu,
  7 May 2020 14:52:52 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTP id C55FC816E2 for
 <pontorez@protonmail.ch>; Thu,
  7 May 2020 17:49:19 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:37506) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jWhdv-00Cs4N-Et for pontorez@pontorez.com; Thu, 07 May
 2020 10:37:08 -0400
...
Authentication-Results: mailin012.protonmail.ch; spf=pass
 smtp.mailfrom=SRS0=WZZERj=6V=rkn.gov.ru=zapret-info-out@pontorez.com
Authentication-Results: mailin012.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="YxfON3E9"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="POE1nq0t"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=tBXqNjLbB3u+o3p24EGWwARd8a/XPnMmELwk/znF4us=; b=YxfON3E9B7I7VvUkm64Bzobb/N
  w5j+jBMg==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1588862121;
 bh=tBXqNjLbB3u+o3p24EGWwARd8a/XPnMmELwk/znF4us=; h=From:To:Subject:Date;
 b=POE1nq0t9QZa80c/92PQ66lQgPuCSrjpXfoM2i/sWH2jRlg3D6G0rWuZuhhCz7x9h
  PxnTpLDGyaPCmg/UTCOZRh+bMwfXzcYHXFDU4zSLZjN1FuxmXacMqrjmAdvn3ZbRRn
  fKcU6KHKV2YK7V5Syew/I5N/j+lXnrrivH6EPisA=
...
Subject: [eais#1112512] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Thu, 7 May 2020 17:35:21 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: https://www2.pontorez.com/pust-proliotsya-krov-banda-moskvy .
