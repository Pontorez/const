Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin005.protonmail.ch (Postfix) with ESMTP id ED3AC402D658 for
 <pontorez@protonmail.ch>; Thu, 14 May 2020 15:15:08 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id DD39F815AD for
 <pontorez@protonmail.ch>; Thu, 14 May 2020 18:11:27 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:48606) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jZFVm-004Q8g-Hz for pontorez@pontorez.com; Thu, 14 May
 2020 11:11:12 -0400
...
Authentication-Results: mailin005.protonmail.ch; spf=pass
 smtp.mailfrom=SRS0=XPJg9u=64=rkn.gov.ru=zapret-info-out@pontorez.com
Authentication-Results: mailin005.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="o4HTuE+o"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="LAHRPQCn"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=//tQd5aTynD0E+6vrX0h1PQzhJRIjgSGJ4XvYV0YS5E=; b=o4HTuE+o6lng/6FYXW1c/QL9UA
  1XZXjcMg==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1589469020;
 bh=//tQd5aTynD0E+6vrX0h1PQzhJRIjgSGJ4XvYV0YS5E=; h=From:To:Subject:Date;
 b=LAHRPQCnipUe6jguW8bIQeWmKjC242WlKewPZDJ/IxWjZgi48ZEXmZtN11Ht25+Gd
  dABFUJymd4T7UkrsosR4BOYo03A1w4h2brlBF6uzk77d7JHGAP80HoPg1qYgXF/V5H
  jZFxrCGojXes04+tv4bdjwqvr8CYBVPUxpY+GFss=
...
Subject: [eais#1114923] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Thu, 14 May 2020 18:10:20 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/paket .
