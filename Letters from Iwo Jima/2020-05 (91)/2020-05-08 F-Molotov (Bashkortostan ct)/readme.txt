Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin010.protonmail.ch (Postfix) with ESMTP id 5C80A3000266 for
 <pontorez@protonmail.ch>; Fri,
  8 May 2020 13:16:43 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 4C2B780F3F for
 <pontorez@protonmail.ch>; Fri,
  8 May 2020 16:13:01 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:56324) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jX2nJ-004iLi-St for pontorez@pontorez.com; Fri, 08 May
 2020 09:12:10 -0400
...
Authentication-Results: mailin010.protonmail.ch; spf=pass
 smtp.mailfrom=SRS0=dO3XfH=6W=rkn.gov.ru=zapret-info-out@pontorez.com
Authentication-Results: mailin010.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="RkI5pGTb"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="pp9v0Max"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=P6jlqM+SMG5GUPudQ1IEFBzjQSXp8HJVNs2fmgL7eqw=; b=RkI5pGTb3slrTwr+L7celxWt3q
  K6V5vRbQ==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1588943480;
 bh=P6jlqM+SMG5GUPudQ1IEFBzjQSXp8HJVNs2fmgL7eqw=; h=From:To:Subject:Date;
 b=pp9v0Maxbr4+THanVjvQVOCuorZ/+UStOUmcu3HqZmUWI5w3w/mwLoINiLnNf+uP1
  wsooSZ0m7PAt3sAffUDC11q8CxdGtiszIU2f1lZyk8CNC7RfbyHBjlNu1g6P/9mFNp
  59wMcuknpj6FPQOGTAcS+TqxmN47ewDZGWRL+Ly8=
...
Subject: [eais#1085735] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Fri, 8 May 2020 16:11:20 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/molotov-cocktail .
