Received: from mx1.rkn.gov.ru (mx1.rkn.gov.ru [87.226.213.147]) (using TLSv1.2 with
 ...
 mailin008.protonmail.ch (Postfix) with ESMTPS id 5A46D3000257 for <pontorez@pm.me>; Mon,
 20 Jan 2020 16:49:36 +0000 (UTC)
...
Authentication-Results: mailin008.protonmail.ch; dkim=pass (1024-bit key)
 header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="MtApXRqX"
X-Client-Proxied-By: ROSKOMNADZOR Secured Mail Server
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1579538975;
 bh=vmbjrIaytl91+bxwE7tLYxuK80Y2O15bqXDETGPjlNY=; h=From:To:Subject:Date;
 b=MtApXRqXDuAayP3f9Nm7WzWIx3YkPSrN4MMwc+mhlOR9HHnZhm6UdFFUHiwHSRwg4
  mgNrByMXbksgQ1LWJgRyPZaPVHkcSKw5kEy0iOHARZuStR84PqHo7jprhzYiqzNrqD
  ygBpiMeNbPlkqFlleQqVI1t+2Ibv02YDKpXcNNIs=
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@pontorez.com>, <pontorez@pm.me>, <abuse@ovh.ca>
Subject: [eais#1014409] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Mon, 20 Jan 2020 19:49:35 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: https://www2.pontorez.com/lullaby-3 .
