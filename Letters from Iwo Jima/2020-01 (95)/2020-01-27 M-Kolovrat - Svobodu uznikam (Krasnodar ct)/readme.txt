Received: from mx1.rkn.gov.ru (mx1.rkn.gov.ru [87.226.213.147]) (using TLSv1.2 with
 ...
 mailin005.protonmail.ch (Postfix) with ESMTPS id 95182402D626 for <pontorez@pm.me>; Mon,
 27 Jan 2020 17:04:10 +0000 (UTC)
...
Authentication-Results: mailin005.protonmail.ch; dkim=pass (1024-bit key)
 header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="mWP6EUb3"
X-Client-Proxied-By: ROSKOMNADZOR Secured Mail Server
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1580144650;
 bh=7/WV4yOiS7JzRVmt7YTUvqjHLr8CgSbT/yDPIyPRL0M=; h=From:To:Subject:Date;
 b=mWP6EUb3PfARDxnchZfCXBtm2tHBEWniBI95eNssXifhmaFRjArAfrN+RK5zZ2Shl
  Xpjuukg9F9FWkzBPD40WBEZC1xeLyi1x8Rd9OPKZAlMZVI/CsCQMY0tWRLhdA70+L5
  9HLUSktjTRJSLYc0rPwBDXceGwbgF5cvPGzgoEYs=
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@pontorez.com>, <pontorez@pm.me>, <abuse@ovh.ca>, <abuse@ovh.ca>
Subject: [eais#1021720] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Mon, 27 Jan 2020 20:04:09 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/svobodu-uznikam .
