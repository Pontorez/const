Received: from mx1.rkn.gov.ru (mx1.rkn.gov.ru [87.226.213.147]) (using TLSv1.2 with
 ...
 mailin004.protonmail.ch (Postfix) with ESMTPS id 9D1D0401008D for <pontorez@pm.me>; Mon,
 27 Jan 2020 11:02:34 +0000 (UTC)
...
Authentication-Results: mailin004.protonmail.ch; dkim=pass (1024-bit key)
 header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="LKQGNclc"
X-Client-Proxied-By: ROSKOMNADZOR Secured Mail Server
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1580122953;
 bh=YM78W56xogBZ4ccd8nFnN1/o6AyOAbdUI1rKiYVtp6c=; h=From:To:Subject:Date;
 b=LKQGNclcXSs/TISZUOHq9gdnBCRQPA+d3reAYrEdLfJ9w+f7/Kz5/XMARhRBhlhbK
  sW27SrYalKCAy7xTNYCgfRHzWczB28PNLtM/wdFqabxqin63uPfZk55rBompDW4HWM
  +OrJCGYa2e78SCxw7UlkPxF/FLNCFu6DjX1n61R4=
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@pontorez.com>, <pontorez@pm.me>, <abuse@ovh.ca>
Subject: [eais#1018336] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Mon, 27 Jan 2020 14:02:33 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/anamalia .
