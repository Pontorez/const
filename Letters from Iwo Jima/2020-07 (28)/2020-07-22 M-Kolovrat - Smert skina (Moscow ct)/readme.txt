Received: from DB8EUR06HT118.eop-eur06.prod.protection.outlook.com
 (2603:10b6:208:91::14) by MN2PR06MB6111.namprd06.prod.outlook.com with HTTPS
 via BL0PR05CA0004.NAMPRD05.PROD.OUTLOOK.COM; Wed, 22 Jul 2020 15:17:00 +0000
Received: from DB8EUR06FT060.eop-eur06.prod.protection.outlook.com
 (2a01:111:e400:fc35::51) by
 DB8EUR06HT118.eop-eur06.prod.protection.outlook.com (2a01:111:e400:fc35::447)
 with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.20.3195.18; Wed, 22 Jul
 2020 15:17:00 +0000
Authentication-Results: spf=permerror (sender IP is 109.201.142.226)
 smtp.mailfrom=rkn.gov.ru; hotmail.com; dkim=pass (signature was verified)
 header.d=rkn.gov.ru;hotmail.com; dmarc=pass action=none
 header.from=rkn.gov.ru;compauth=pass reason=100
Received-SPF: PermError (protection.outlook.com: domain of rkn.gov.ru used an
 invalid SPF mechanism)
Received: from smtp04.topdns.com (109.201.142.226) by
 DB8EUR06FT060.mail.protection.outlook.com (10.233.253.39) with Microsoft SMTP
 Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.20.3216.10 via Frontend Transport; Wed, 22 Jul 2020 15:16:59 +0000
X-IncomingTopHeaderMarker:
 OriginalChecksum:F785516228030E8F605015109D0F13FE3DDCAF2DBD0815D909482A6D7ABB5CFE;UpperCasedChecksum:FB72DB734684E555520319E44808BBB1C62F96F8285B21AB07B4C102D30B3BA4;SizeAsReceived:1323;Count:10
Received-SPF: pass (rkn.gov.ru: 87.226.213.147 is authorized to use 'zapret-info-out@rkn.gov.ru' in 'mfrom' identity (mechanism 'a:mx1.rkn.gov.ru' matched)) receiver=srv913; identity=mailfrom; envelope-from="zapret-info-out@rkn.gov.ru"; helo=mx1.rkn.gov.ru; client-ip=87.226.213.147
Received: from mx1.rkn.gov.ru (mx1.rkn.gov.ru [87.226.213.147])
	by smtp04.topdns.com (Postfix) with ESMTPS id 88CA319E084D
	for <pontorez@pontorez.com>; Wed, 22 Jul 2020 17:16:58 +0200 (CEST)
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim;
	t=1595431017; bh=8/LMcyxf3fTEN07Ln3A2IaWMLOXdwEN30vWoER5eOWo=;
	h=From:To:Subject:Date;
	b=ET/gdPmN9NDVW1WwO20oeK95Isbb8nzbKi0NSZdhqekTUuDvNTEkSVL+dHTcHrpPh
	 VVX9rN+sEffomoE2bedYp7JuPGsVBG6PCfC4pdIlGv4Fyzl0sMN0cIsnGa4C6/tKW/
	 IP8dze2iuR9XWAdbWrc6yUJqGROP85HiZVXG2Z5w=
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@pontorez.com>, <pontorez@pm.me>, <abuse@ovh.ca>
Subject: [eais#1184805] Роскомнадзор информирует/the Roscomnadzor is informing
Content-Type: multipart/mixed; boundary="5ae9ec9d63fdfc446aafc3bc78fea574"
Date: Wed, 22 Jul 2020 18:16:57 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: https://wvw.pontorez.com/kolovrat.smert_skina .
