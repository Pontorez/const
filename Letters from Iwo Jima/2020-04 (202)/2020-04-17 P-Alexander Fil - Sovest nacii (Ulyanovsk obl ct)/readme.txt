Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin010.protonmail.ch (Postfix) with ESMTP id 2F39C3000245 for
 <pontorez@protonmail.ch>; Fri, 17 Apr 2020 12:56:38 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id AFEA481698 for
 <pontorez@protonmail.ch>; Fri, 17 Apr 2020 15:56:10 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:40082) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jPQUz-00F75D-1R for pontorez@pontorez.com; Fri, 17 Apr
 2020 08:53:44 -0400
...
Authentication-Results: mailin010.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="ju0N0tkZ"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="UHw4iozu"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=/dNq3yqggl0YwRJ27k6sCdZ6hYv07SsEBNgFPH8fDnU=; b=ju0N0tkZbSyz7Q/WqaDmwuUzfW
  pbV/eF9Q==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1587127880;
 bh=/dNq3yqggl0YwRJ27k6sCdZ6hYv07SsEBNgFPH8fDnU=; h=From:To:Subject:Date;
 b=UHw4iozubaq92xWMgxbu+b2oWNNvvfD890fEpi3ygpz0kDgELHhswW/KkcV1DT7Zt
  wAgXoYhllwJTbXavpJo6GNIUM8483JQHtlY/pVvZzv3Zak7aFzwtb2YcRgL4q6vqk3
  HxJuvpztUmz7zR6owrnb7OieuhRmxlRvgbM0HNhI=
...
Subject: [eais#1096801] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Fri, 17 Apr 2020 15:51:20 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/sovest-nacii .
