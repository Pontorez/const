Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin015.protonmail.ch (Postfix) with ESMTP id 79ACB300025B for
 <pontorez@protonmail.ch>; Fri, 17 Apr 2020 12:52:09 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id A628C81465 for
 <pontorez@protonmail.ch>; Fri, 17 Apr 2020 15:52:06 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:39468) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jPQTN-00F6ir-RB for pontorez@pontorez.com; Fri, 17 Apr
 2020 08:52:05 -0400
...
Authentication-Results: mailin015.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="NMG/tdIU"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="o+ON8uqF"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=9sOK1dpF4X/n07TRsS+Ss2lNLvxFvtHiO49bM/Zruvg=; b=NMG/tdIUNkEPfoHwkIWXq2eyQH
  ICf0ZL/A==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1587127874;
 bh=9sOK1dpF4X/n07TRsS+Ss2lNLvxFvtHiO49bM/Zruvg=; h=From:To:Subject:Date;
 b=o+ON8uqF+VYI9U4CvzYJycWfQdIBYGChfuSQfStECDDyKkYNtHi0RHotVImSOxN47
  PIsADNWIbrvADaDOyggeQ3eyTVnxsFhNQD0zY2ZQxmAz8QYMuoieL0lLngpz6mMpm/
  J6oQr6nUsh6biH0oZlB812wtYR2eME8jQMx2OANU=
...
Subject: [eais#1096794] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Fri, 17 Apr 2020 15:51:14 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/lomonosov-oda-na-vzyatie-ierusalima .
