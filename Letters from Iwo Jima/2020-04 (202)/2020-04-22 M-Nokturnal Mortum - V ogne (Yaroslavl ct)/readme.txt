Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin006.protonmail.ch (Postfix) with ESMTP id 60F004016D88 for
 <pontorez@protonmail.ch>; Wed, 22 Apr 2020 16:46:45 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 2DA00816CE for
 <pontorez@protonmail.ch>; Wed, 22 Apr 2020 19:46:43 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:60726) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jRIWB-005vZt-CY for pontorez@pontorez.com; Wed, 22 Apr
 2020 12:46:42 -0400
...
Authentication-Results: mailin006.protonmail.ch; spf=pass
 smtp.mailfrom=SRS0=fJF2lX=6G=rkn.gov.ru=zapret-info-out@pontorez.com
Authentication-Results: mailin006.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="dIVam6GO"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="mzjqK+Wt"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=W8kN+PSXqkCJDFJ2yFdtEr/VFNOvNjfGS+e4o42sXEc=; b=dIVam6GO6hJbsDJXIujmJGPnXf
  EWqz1tew==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1587573953;
 bh=W8kN+PSXqkCJDFJ2yFdtEr/VFNOvNjfGS+e4o42sXEc=; h=From:To:Subject:Date;
 b=mzjqK+WtDMInVKOjRMtlq8Lf0veNsqOtwEZTI+be/J/AN2vyap6JNrzjBFjrmavVM
  +10s44/W9BQaek2sGrweratbC6I8Bz53ufVMfgD3U1wlBVzUZDHSFeFxRtokPrVzHk
  fw2NZkGU3qRtaFim4AXrhq5w9695RfqhsKglC+6w=
...
Subject: [eais#1101040] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Wed, 22 Apr 2020 19:45:53 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/nokturnal-mortum-w-ogne .
