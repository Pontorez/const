Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin004.protonmail.ch (Postfix) with ESMTP id 567BF4010096 for
 <pontorez@protonmail.ch>; Tue, 21 Apr 2020 19:00:37 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 64620816ED for
 <pontorez@protonmail.ch>; Tue, 21 Apr 2020 21:59:42 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:48044) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jQy7K-000o9n-83 for pontorez@pontorez.com; Tue, 21 Apr
 2020 14:59:41 -0400
...
Authentication-Results: mailin004.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="Ydb3PCer"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="q2U9Lpx/"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=c97o1NdUfI/heZ5OYtg4YbVPov+36rfu54kW/JlDYq8=; b=Ydb3PCer6JD7yNxTyf9pXUkfOj
  ayKItiig==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1587495443;
 bh=c97o1NdUfI/heZ5OYtg4YbVPov+36rfu54kW/JlDYq8=; h=From:To:Subject:Date;
 b=q2U9Lpx/ek6CnIStBVSgrSr2+NW7H5/aSoPyIZvpq3qluORs+dXRgNCzR6KWlKyTm
  FRO+iL7SHCLVrpxxfwRWMbguXTyQuKZ67GfA6Kcq2tY0/+gIp6hQufDmD8iPGv9DKM
  mRzsdcBbeWuPob6DRFHKj/gck0yyPGYU+CsNXTpg=
...
Subject: [eais#1099451] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Tue, 21 Apr 2020 21:57:23 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/kolovrat-policeyskoe.gosudarstvo .
