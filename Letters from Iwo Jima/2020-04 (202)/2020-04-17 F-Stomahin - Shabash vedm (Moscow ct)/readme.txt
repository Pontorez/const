Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin007.protonmail.ch (Postfix) with ESMTP id 1B905300025F for
 <pontorez@protonmail.ch>; Fri, 17 Apr 2020 12:56:10 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 4E26A835AB for
 <pontorez@protonmail.ch>; Fri, 17 Apr 2020 15:54:03 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:40088) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jPQV1-00F75e-AK for pontorez@pontorez.com; Fri, 17 Apr
 2020 08:53:48 -0400
...
Authentication-Results: mailin007.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="U2MCCKpr"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="X0O/jbou"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=ubZhKCpXK6LI6jBesQoEMCi8MnYWgvlKe3Te0pYFnkQ=; b=U2MCCKprs1RB+MSfmUR/2WpUgr
  zHDgBtmw==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1587127881;
 bh=ubZhKCpXK6LI6jBesQoEMCi8MnYWgvlKe3Te0pYFnkQ=; h=From:To:Subject:Date;
 b=X0O/jbouZmxqhpVCmai2TVd/zz6Y4GmE2hQz0bV9+SUOplT5+fMArhfPSgw5iPkXr
  lKQfTZ0JO8xQX03GHo+DKfEc2wIFbvyhmGo7zg6sASs3gzcoFzCQObCqslmG2KsIkS
  kPOI7u35XITVxBPkutAyC4JpEW+GgUGe65iZw7Mw=
...
Subject: [eais#1096823] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Fri, 17 Apr 2020 15:51:21 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/shabash-vedm .
