Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin005.protonmail.ch (Postfix) with ESMTP id AFCC7401007D for
 <pontorez@protonmail.ch>; Fri, 17 Apr 2020 13:15:27 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 5C9CF81698 for
 <pontorez@protonmail.ch>; Fri, 17 Apr 2020 16:14:57 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:40072) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jPQUu-00F74n-BF for pontorez@pontorez.com; Fri, 17 Apr
 2020 08:53:39 -0400
...
Authentication-Results: mailin005.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="MWPrdJf/"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="rmsu+lSu"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=SwQx/BhSDxb/okxkMSJ6qHalDpDwVj+0bLf3h269ps8=; b=MWPrdJf/+fUJ52y96cwwH5sZK9
  TxTdPxdw==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1587127879;
 bh=SwQx/BhSDxb/okxkMSJ6qHalDpDwVj+0bLf3h269ps8=; h=From:To:Subject:Date;
 b=rmsu+lSuMBMmv+MIPDofFo/GhkIHT7cxoegFGRYhC2jM6RUBKLPIVa4x4+6RjRNEm
  vLa5Xb2PWr+IlSdX6kbJ+E4hVEclh5iODfDOj9r7NghO13ot4wahHFw/+uQVwUzHLd
  VZrKc2BwaBwyNwo9Z9jaw8jOll87G/LXoLsihm1g=
...
Subject: [eais#1096799] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Fri, 17 Apr 2020 15:51:19 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/po-rusi-gulyaet-smert .
