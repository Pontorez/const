Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin007.protonmail.ch (Postfix) with ESMTP id 7DAE3300026B for
 <pontorez@protonmail.ch>; Tue,
  7 Apr 2020 14:49:06 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 0666480C56 for
 <pontorez@protonmail.ch>; Tue,
  7 Apr 2020 17:47:04 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:52308) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jLpUP-00Bq3L-Bf for pontorez@pontorez.com; Tue, 07 Apr
 2020 10:46:16 -0400
...
Authentication-Results: mailin007.protonmail.ch; spf=pass
 smtp.mailfrom=SRS0=RfzyMb=5X=rkn.gov.ru=zapret-info-out@pontorez.com
Authentication-Results: mailin007.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="LAsm59AX"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="dKx5Jzb4"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=8jbnm+Zq+1YatNGAAooyZP0xALU93CpfUNCiZRXKjE4=; b=LAsm59AXw84F0By7NKkpXdTpws
  +njBo0Fg==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1586270727;
 bh=8jbnm+Zq+1YatNGAAooyZP0xALU93CpfUNCiZRXKjE4=; h=From:To:Subject:Date;
 b=dKx5Jzb43pLOHoc4c4+1aYScMWGolrBCVHZamC46FVm+wPCMod2fzf+OafPUEPORZ
  4ba2Lp81UCScCp2YOakVaP+wwfYsqSy653A8Emz1ukQzJYxcO5M+ewWWY/s06yNzDg
  VH4k9fEIAm99rVukVxUQSUsRz/W2aLHdXrtseC+0=
...
Subject: [eais#1084673] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Tue, 7 Apr 2020 17:45:27 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/kolovrat_vera_v_ns .
