Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin011.protonmail.ch (Postfix) with ESMTP id 771194010074 for
 <pontorez@protonmail.ch>; Mon,
  6 Apr 2020 12:43:20 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 5049D83BEB for
 <pontorez@protonmail.ch>; Mon,
  6 Apr 2020 15:38:38 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:52500) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jLQyf-002YYx-Po for pontorez@pontorez.com; Mon, 06 Apr
 2020 08:35:53 -0400
...
Authentication-Results: mailin011.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="POECvtoX"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="PxSq8akH"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=VPIWMie8UbPnsF6dau4Fmg3dUf2pOrfa3VhA+vH2Swk=; b=POECvtoXeszBSYHWQyX7edLl3x
  a4H1GKIQ==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1586176503;
 bh=VPIWMie8UbPnsF6dau4Fmg3dUf2pOrfa3VhA+vH2Swk=; h=From:To:Subject:Date;
 b=PxSq8akHnc0P/zfICcxVoqKk5WK916YsTODmEa1QGjunAyp9L6mxix8tzt5icckop
  5Tr0M+mnVzHMwRQLpoPcy8VV3L4uNz0gEqz1+ziMiADkGeTKOXHpQqwhdLst72SfiI
  XXS6omubHQufbaFADhCgrWTG622dxWEEM55eEveQ=
...
Subject: [eais#1081811] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Mon, 6 Apr 2020 15:35:03 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: https://www2.pontorez.com/argentina-sex-draka .
