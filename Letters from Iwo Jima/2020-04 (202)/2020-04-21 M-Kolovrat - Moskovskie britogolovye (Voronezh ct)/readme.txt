Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin004.protonmail.ch (Postfix) with ESMTP id A3F0C4011DC8 for
 <pontorez@protonmail.ch>; Tue, 21 Apr 2020 19:31:56 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 431F3809A9 for
 <pontorez@protonmail.ch>; Tue, 21 Apr 2020 22:31:33 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:51430) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jQyN6-000rZH-Nh for pontorez@pontorez.com; Tue, 21 Apr
 2020 15:16:04 -0400
...
Authentication-Results: mailin004.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="TP8pFuur"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="B63omCUe"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=wfiiAt4tMDPmioTG010ziwrKl/H5Wsg5dStUybjC8YI=; b=TP8pFuur+4aG9AwFDZm6qu6N6q
  KBSCxPNQ==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1587496511;
 bh=wfiiAt4tMDPmioTG010ziwrKl/H5Wsg5dStUybjC8YI=; h=From:To:Subject:Date;
 b=B63omCUecsonUrJpLATdTzFKTRiA1l3kov+tNyNcsdgRL1OBQwKTRRNcLldJshPqh
  9RU5aVzpowVjUcUzyhBM82YZx8l+4jZ/1XUzXsEOlhnxdpOk9itUpQfJbpWPeumb0w
  dZNgBogjfX5SO2RN/PfZfcw5+ekVRxOQUIEXUAe0=
...
Subject: [eais#1100403] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Tue, 21 Apr 2020 22:15:11 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/kolovrat.moscovskie.britogolovye .
