Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin005.protonmail.ch (Postfix) with ESMTP id 9AF7E402D62F for
 <pontorez@protonmail.ch>; Wed,
  1 Apr 2020 14:07:17 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 492B181949 for
 <pontorez@protonmail.ch>; Wed,
  1 Apr 2020 17:06:45 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:58490) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jJe0Q-00E6Gw-I4 for pontorez@pontorez.com; Wed, 01 Apr
 2020 10:06:50 -0400
...
Authentication-Results: mailin005.protonmail.ch; spf=pass
 smtp.mailfrom=SRS0=Ju1TAL=5R=rkn.gov.ru=zapret-info-out@pontorez.com
Authentication-Results: mailin005.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="Gnz7Hjh+"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="W9IOHh/Q"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=CrkmxSuSPWrdci9p8pVle35+xPSVz0+Mu1J3NiHhXRQ=; b=Gnz7Hjh+HgFRtgTjAb/KV1dAaI
  rdWOXCHA==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1585749908;
 bh=CrkmxSuSPWrdci9p8pVle35+xPSVz0+Mu1J3NiHhXRQ=; h=From:To:Subject:Date;
 b=W9IOHh/QoEhsWPoVcGNoDsGfiRC1cnkCAW+731IpyFWIIw7CLk99j4vu9tYWn/SLn
  /McwtJoH4isWgDvtO41pG7+xZq23QwkuxpB6dx+DNDqO948Ng7VP1lidxyCOXLUtEf
  KI9zm4xEByyYU3Q8B1CUvtgAlvowsN70NcPUaP98=
...
Subject: [eais#1074395] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Wed, 1 Apr 2020 17:05:08 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: https://www2.pontorez.com/kak-sdelat-poroh .
