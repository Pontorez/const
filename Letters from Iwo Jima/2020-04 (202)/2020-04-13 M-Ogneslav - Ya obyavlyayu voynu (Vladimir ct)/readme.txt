Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin006.protonmail.ch (Postfix) with ESMTP id 157BE4010096 for
 <pontorez@protonmail.ch>; Mon, 13 Apr 2020 16:01:16 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id A30848087D for
 <pontorez@protonmail.ch>; Mon, 13 Apr 2020 19:01:13 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:47654) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jO1WD-00DVsz-8p for pontorez@pontorez.com; Mon, 13 Apr
 2020 12:01:13 -0400
...
Authentication-Results: mailin006.protonmail.ch; spf=pass
 smtp.mailfrom=SRS0=hmgv3I=55=rkn.gov.ru=zapret-info-out@pontorez.com
Authentication-Results: mailin006.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="Yecd1tmD"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="WnExqp01"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=5nHKMIf/OYavLidL1HIR4qZR1k99f5GJ1msHZ6suuyA=; b=Yecd1tmDyRfubJVecczXIMhJTm
  b2FM5lHA==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1586793620;
 bh=5nHKMIf/OYavLidL1HIR4qZR1k99f5GJ1msHZ6suuyA=; h=From:To:Subject:Date;
 b=WnExqp012dVt/ojdBfyMSqN7oRwfzCI+btbqX5XEO+4QySLA8ohDF0qRLITmfVQw+
  WSd3ieIdAkY4SG1j3nofarPELKBozZ/d4RNFQGlof2/pTSmsSohmr+/yavsPwnDStG
  TVXT26ALKGhtAsCDKpShIKq680mgku/Qvn5QlJ6A=
...
Subject: [eais#1091624] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Mon, 13 Apr 2020 19:00:20 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/ogneslav-war .
