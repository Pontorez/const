Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin006.protonmail.ch (Postfix) with ESMTP id AA4924010090 for
 <pontorez@protonmail.ch>; Mon, 27 Apr 2020 15:35:04 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id CCE268271E for
 <pontorez@protonmail.ch>; Mon, 27 Apr 2020 18:34:02 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:60342) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jT5lT-002SfY-7k for pontorez@pontorez.com; Mon, 27 Apr
 2020 11:33:55 -0400
...
Authentication-Results: mailin006.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="m90/za77"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="SW4dGhW0"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=0AXPHjIQwxG8qp+ezlGP8uXfJWOqM9qoCMbFfQnO7Mg=; b=m90/za77pG6eEqE/aGgGQuJwVK
  tpsk2u4Q==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1588001159;
 bh=0AXPHjIQwxG8qp+ezlGP8uXfJWOqM9qoCMbFfQnO7Mg=; h=From:To:Subject:Date;
 b=SW4dGhW0k9rOAo22G7Ru4+Jrw6EJgnOctrE+DsoLjKN6qAd4QJUNm9Puim5u0y0jY
  E3vDbR3ReX/IucGbLxERxGsC1BeJ3raWZqKBFDnUMCHMjG+jPFYanmdfyRMda9Fj82
  OlXfcIr0QXjku3ryga+ubxGZadC/2txRoBf0ecY0=
...
Subject: [eais#1104941] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Mon, 27 Apr 2020 18:25:59 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/huk-sprava-pro-tolerantnost .
