Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin004.protonmail.ch (Postfix) with ESMTP id 471734010074 for
 <pontorez@protonmail.ch>; Tue, 21 Apr 2020 19:25:59 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 7CB1D816ED for
 <pontorez@protonmail.ch>; Tue, 21 Apr 2020 22:25:56 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:53400) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jQyWh-000tYY-TV for pontorez@pontorez.com; Tue, 21 Apr
 2020 15:25:55 -0400
...
Authentication-Results: mailin004.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="oge1pT3o"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="KfDy/Hh8"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=T3Z3lJdJ3S0Ft32Q6lkfvqwF5nnXiKts9N+Lr3jUiYU=; b=oge1pT3o+TGJinsaL28rctWRFn
  zs5ZbHcA==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1587497106;
 bh=T3Z3lJdJ3S0Ft32Q6lkfvqwF5nnXiKts9N+Lr3jUiYU=; h=From:To:Subject:Date;
 b=KfDy/Hh8CTmslP5t0kdECX4y4O1mvU/oh+BCjSgkx6cbWyf6ac9pUrQiXTiBfVdNu
  QwcVh6C4Y9X13Ya3xV8aXiK6Kdn7jYB+4veYJCUtOuNVVjpebwhsUf9at5JfZ9n8OX
  eBxtj3raWNDPuycdoHz4qsyXaK+gNk1OTeaLPDhA=
...
Subject: [eais#1100587] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Tue, 21 Apr 2020 22:25:06 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/timur_mutsuraev_12000-modzhahedov .
