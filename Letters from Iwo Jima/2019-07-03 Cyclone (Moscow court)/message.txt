Received: from mx1.rkn.gov.ru ([87.226.213.147]:56634) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1hicJT-00EVF6-R7 for pontorez@pontorez.com; Wed, 03 Jul
 2019 06:16:38 -0400
X-Client-Proxied-By: ROSKOMNADZOR Secured Mail Server
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@pontorez.com>, <abuse@ovh.ca>, <abuse@ovh.ca>
Subject: [eais#857239] Роскомнадзор информирует/the Roscomnadzor is informing
Date: Wed, 3 Jul 2019 13:15:45 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://pontorez.com/l/z_Циклон-Б_-_В_память_героям.txt .
