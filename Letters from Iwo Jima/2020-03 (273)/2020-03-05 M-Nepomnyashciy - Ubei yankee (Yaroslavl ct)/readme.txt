Received: from mx1.rkn.gov.ru (mx1.rsoc.ru [87.226.213.147]) (using TLSv1.2 with cipher
 ...
 mailin008.protonmail.ch (Postfix) with ESMTPS id 680BD300025E for <pontorez@pm.me>; Thu,
  5 Mar 2020 15:22:43 +0000 (UTC)
...
Authentication-Results: mailin008.protonmail.ch; dkim=pass (1024-bit key)
 header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="Nsnu3MQ7"
X-Client-Proxied-By: ROSKOMNADZOR Secured Mail Server
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1583421762;
 bh=TVwI71TK4w9BzBDugDAOGFpGRZIPVyLv3dNEFFJTNac=; h=From:To:Subject:Date;
 b=Nsnu3MQ7RZ3pa7e379rL+RKHuKzuP7YT77zLQ38yDfodRlH5V+Ab7mTAjzpoZsDlK
  +OsAJW1NqCYUNeNj3eo7GDAsRLknfRgtqjSW14fN2fkQfRzOePh9Mgqy0vJXtai1WK
  djHkHJ4QaK4MplvAnY7MjdXV24Ru/HhM3yulBwIM=
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@pontorez.com>, <pontorez@pm.me>, <abuse@ovh.ca>
Subject: [eais#1054827] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Thu, 5 Mar 2020 18:22:42 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: https://www2.pontorez.com/yanki .
