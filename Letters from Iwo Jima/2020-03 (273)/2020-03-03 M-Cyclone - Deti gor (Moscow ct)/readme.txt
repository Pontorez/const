Received: from mx1.rkn.gov.ru (mx1.rkn.gov.ru [87.226.213.147]) (using TLSv1.2 with
 ...
 mailin015.protonmail.ch (Postfix) with ESMTPS id C3B45300024F for <pontorez@pm.me>; Tue,
  3 Mar 2020 12:10:22 +0000 (UTC)
...
Authentication-Results: mailin015.protonmail.ch; dkim=pass (1024-bit key)
 header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="S76oPW3M"
X-Client-Proxied-By: ROSKOMNADZOR Secured Mail Server
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1583237422;
 bh=Afoq/XKhu07CvY9gFwVNUgJR/k2KCq1J/U9IalRZQj4=; h=From:To:CC:Subject:Date;
 b=S76oPW3MCxRoYnVq3FFfhEuErU/zIbG4swH3IgTYuJH5oS9UU/y94iKf3bYko0Fj/
  lXwSI5sn3HWFD65i22mUBF7OTFcfd3feRYBlCXj+AaDNS4fLhg2FTfxY6PRiP5IPrT
  ztW2I2JPO1WEwqhwMlf6GM8zIEhCq3BmY6tcoC+4=
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@pontorez.com>, <pontorez@pm.me>, <abuse@ovh.ca>
Cc: <noc@ovh.net>
Subject: [eais#1052231] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Tue, 3 Mar 2020 15:10:21 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: https://www2.pontorez.com/ciclone-b-deti-gor .
