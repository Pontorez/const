Received: from mx1.rkn.gov.ru (mx1.rkn.gov.ru [87.226.213.147]) (using TLSv1.2 with
 ...
 mailin006.protonmail.ch (Postfix) with ESMTPS id 00E3840166BF for <pontorez@pm.me>; Mon,
  2 Mar 2020 16:05:50 +0000 (UTC)
...
Authentication-Results: mailin006.protonmail.ch; dkim=pass (1024-bit key)
 header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="ho3KQZPk"
X-Client-Proxied-By: ROSKOMNADZOR Secured Mail Server
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1583165150;
 bh=lMXOEBn3ShBMZ4whuHMVFfjv5wNStgwX+0Z6xCt6lIM=; h=From:To:Subject:Date;
 b=ho3KQZPkRTnlCU/yh9KAtkcnjenOGbY/Jc3p8xnnEXwSL6MspdhhEzwGzwPiZ49jn
  YaCMJIZzHRbm8dS3t/65cQ4M/xzUxvEAfthMbAq6dwXmXGLQj/h7gW/Ravmw3NHlrC
  K25kAINoyYUsxTh97LJQELslZJ8AfNuS47yqU4ro=
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@pontorez.com>, <pontorez@pm.me>, <abuse@ovh.ca>
Subject: [eais#1051356] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Mon, 2 Mar 2020 19:05:49 +0300 (MSK)
