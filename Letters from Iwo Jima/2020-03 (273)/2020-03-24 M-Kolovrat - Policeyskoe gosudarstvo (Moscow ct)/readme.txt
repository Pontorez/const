Received: from mx1.rkn.gov.ru (mx1.rsoc.ru [87.226.213.147]) (using TLSv1.2 with cipher
 ...
 mailin012.protonmail.ch (Postfix) with ESMTPS id 387C940124EE for <pontorez@pm.me>; Tue,
 24 Mar 2020 20:05:33 +0000 (UTC)
...
Authentication-Results: mailin012.protonmail.ch; dkim=pass (1024-bit key)
 header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="lds1geXc"
X-Client-Proxied-By: ROSKOMNADZOR Secured Mail Server
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1585080332;
 bh=PxCFW+5yYihBQPpKZPx//EQb5H9gXELQLBVXH4Qz9Zk=; h=From:To:Subject:Date;
 b=lds1geXcw23h8xyB+XokBfPvrcwiuIfeZfIF6zmT5hpBhMQSODDD9sXcFvCuquxjI
  t2OOfUMVHQzH+tc5vuie7fb41NspObUDt7lvpO4ml4tp/6ZJQ0L2bUMjJgXU59k04b
  x69uW0OhiflLtRxFAqbH6KMnieCGaXPfylpkif5M=
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@pontorez.com>, <pontorez@pm.me>, <abuse@ovh.ca>, <abuse@ovh.ca>,
 <abuse@ovh.ca>
Subject: [eais#1071519] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Tue, 24 Mar 2020 23:05:31 +0300 (MSK)
