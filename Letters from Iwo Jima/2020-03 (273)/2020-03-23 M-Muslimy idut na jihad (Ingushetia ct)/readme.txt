Received: from mx1.rkn.gov.ru (mx1.rsoc.ru [87.226.213.147]) (using TLSv1.2 with cipher
 ...
 mailin010.protonmail.ch (Postfix) with ESMTPS id 50D5F300026F for <pontorez@pm.me>; Mon,
 23 Mar 2020 15:06:24 +0000 (UTC)
...
Authentication-Results: mailin010.protonmail.ch; dkim=pass (1024-bit key)
 header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="BBBO3i9q"
X-Client-Proxied-By: ROSKOMNADZOR Secured Mail Server
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1584975983;
 bh=me0EY4zodq1cOis/s4JsBReVnZ7pEojw0GbIs4l8hoY=; h=From:To:Subject:Date;
 b=BBBO3i9qn7qGv2OfpYrP9djUO4IOO0WIIoMKMG3/1AJG1LxWuWd7rlvPsoJMZIj10
  dnHVTe3PM3CBjDjT+4IOlv9HaS/8+bJWiUQJmuJB07W8DplCqjhVHD72s1jwORTHo9
  dkG5357AcyI8SolOYrm4Ur3aXhCQ+vzQgjvEc9GM=
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@pontorez.com>, <pontorez@pm.me>, <abuse@ovh.ca>, <abuse@ovh.ca>,
 <abuse@ovh.ca>
Subject: [eais#1069628] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Mon, 23 Mar 2020 18:06:20 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: https://www2.pontorez.com/nashid-muslimy-idut-na-jihad .
