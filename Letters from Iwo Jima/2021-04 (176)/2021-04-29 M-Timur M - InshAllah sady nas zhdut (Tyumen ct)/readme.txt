Received: from DB8EUR05HT069.eop-eur05.prod.protection.outlook.com
 (2603:10b6:408:f8::21) by BN6PR1001MB2113.namprd10.prod.outlook.com with
 HTTPS via BN9PR03CA0226.NAMPRD03.PROD.OUTLOOK.COM; Thu, 29 Apr 2021 21:06:15
 +0000
Received: from DB8EUR05FT045.eop-eur05.prod.protection.outlook.com
 (2a01:111:e400:fc0f::46) by
 DB8EUR05HT069.eop-eur05.prod.protection.outlook.com (2a01:111:e400:fc0f::292)
...
Received: from mx1.rkn.gov.ru (87.226.213.147) by
 DB8EUR05FT045.mail.protection.outlook.com (10.233.239.127) with Microsoft
 SMTP Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.20.4087.27 via Frontend Transport; Thu, 29 Apr 2021 21:06:13 +0000
X-IncomingTopHeaderMarker:
 OriginalChecksum:CB2D99D5188EDDDA8BF584DEB256569B68E6F6F090B23368AC2ACDA6EFEE9B2A;UpperCasedChecksum:FA26BD322D7539E7FAA5B9705EEDF1898901DC4A4FBF8E7A0A9A0DD3047F50E3;SizeAsReceived:862;Count:8
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim;
	t=1619730372; bh=BRyGg4i2rkHIcGodz/+eE8VhkMnhf/pxoINJREhYavE=;
	h=From:To:Subject:Date;
	b=EZ5+KDfHMoUwB/+oOii/0AdzOirEDZ1jn7kfwK35Ht8G3xLPoplbVOZmSfG2EBN4b
	 iSfOL+b3thYXuCl3/JRmn5RFnwTB+7GudbqubyP96bRhyWY+AW7ivHUIrvvLRK1PoV
	 yLF1fmZOAbvs0Z4LsyIB9l1DmMxysgBkqMJow6lQ=
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@hotmail.com>, <conseev@cloudequitygroup.com>, <abuse@dedipath.com>
Subject: [eais#1440496] Роскомнадзор информирует/the Roscomnadzor is informing
Content-Type: multipart/mixed; boundary="43798c7b691d82e62e7e331ee981cc82"
Date: Fri, 30 Apr 2021 00:06:12 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://pontorez.net/timur.mutsuraev.inshallah.sady.nas.zhdut .
