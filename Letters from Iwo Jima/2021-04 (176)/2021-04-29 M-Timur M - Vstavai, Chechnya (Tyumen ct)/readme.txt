Received: from DB8EUR05HT042.eop-eur05.prod.protection.outlook.com
 (2603:10b6:408:e4::31) by BN6PR1001MB2113.namprd10.prod.outlook.com with
 HTTPS via BN0PR02CA0026.NAMPRD02.PROD.OUTLOOK.COM; Thu, 29 Apr 2021 21:06:14
 +0000
Received: from DB8EUR05FT017.eop-eur05.prod.protection.outlook.com
 (2a01:111:e400:fc0f::4b) by
 DB8EUR05HT042.eop-eur05.prod.protection.outlook.com (2a01:111:e400:fc0f::331)
 with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.20.4087.27; Thu, 29 Apr
 2021 21:06:12 +0000
Authentication-Results: spf=pass (sender IP is 87.226.213.147)
...
Received-SPF: Pass (protection.outlook.com: domain of rkn.gov.ru designates
 87.226.213.147 as permitted sender) receiver=protection.outlook.com;
 client-ip=87.226.213.147; helo=mx1.rkn.gov.ru;
Received: from mx1.rkn.gov.ru (87.226.213.147) by
 DB8EUR05FT017.mail.protection.outlook.com (10.233.239.55) with Microsoft SMTP
 Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.20.4087.27 via Frontend Transport; Thu, 29 Apr 2021 21:06:12 +0000
X-IncomingTopHeaderMarker:
 OriginalChecksum:2519F149DE32F5E1EB3E1C49788837C3A6C6A2F08BA3F7BD8EA18BB44F45EF5F;UpperCasedChecksum:901F80E9ED5D57A25CF564CB118A0C5FA16941460A8FD9A9A950CD792C7DBA30;SizeAsReceived:862;Count:8
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim;
	t=1619730371; bh=hWJiM/uYxlvL7xvhfK1XfeFyMzNiefXYRMkhBwK/eSw=;
	h=From:To:Subject:Date;
	b=py+gZkn6W4EeEHw7Ns2bIjpDSAIJQwdG2E9Ajag7d+0sMcbYHXky25DKESBZKJpXl
	 tsSgcWKJldQ52PIaCFBMjfIrbibUAKza6Du8BwnOTDIWVxB4C7WtI02OQfpPmDjXqy
	 N/1MxY1knfw6jS2f3gekGAXrpA1AvC3S7x4b1QJg=
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@hotmail.com>, <conseev@cloudequitygroup.com>, <abuse@dedipath.com>
Subject: [eais#1440494] Роскомнадзор информирует/the Roscomnadzor is informing
Content-Type: multipart/mixed; boundary="43cefbaae0c85e45a52d90901364b962"
Date: Fri, 30 Apr 2021 00:06:11 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://pontorez.net/timur-mutsuraev-vstavai-chechnya .
