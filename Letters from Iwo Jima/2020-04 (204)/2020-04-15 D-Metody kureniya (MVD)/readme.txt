Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin007.protonmail.ch (Postfix) with ESMTP id 31C6D3000247 for
 <pontorez@protonmail.ch>; Wed, 15 Apr 2020 15:51:00 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id BD5C2808A3 for
 <pontorez@protonmail.ch>; Wed, 15 Apr 2020 18:50:57 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:37772) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jOkJM-0066Y4-KB for pontorez@pontorez.com; Wed, 15 Apr
 2020 11:50:56 -0400
...
Authentication-Results: mailin007.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="JnRn+Zxc"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="dIrSeyAg"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=JwRCtbWfXzDxq8s0n+CCwKN/hxlKnZcCkrBqsjWFOZ0=; b=JnRn+ZxcnIxUM1EAG5eK6hAL6J
  6xWg/5zQ==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1586965807;
 bh=JwRCtbWfXzDxq8s0n+CCwKN/hxlKnZcCkrBqsjWFOZ0=; h=From:To:Subject:Date;
 b=dIrSeyAgmmEDwD2WcGJP34zM3GPG4o+8XKMHijtDnYq/QwBGZin5uSKS+IksZ52qV
  QAnJ3g+dJw+m4OEbfs8nVIv+CbSHlWdJmC9Hg/fdOGlXglIqWVNpLmfQE1R/IYNXMk
  dpKypLkbWmuPL+L7VGJSsHpXBr5k2T1Z0DM5LOLo=
...
Subject: [eais#1093397] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Wed, 15 Apr 2020 18:50:07 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/methods .
