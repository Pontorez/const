Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin004.protonmail.ch (Postfix) with ESMTP id 2D3224010092 for
 <pontorez@protonmail.ch>; Tue, 21 Apr 2020 19:04:58 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 1CF3983BE7 for
 <pontorez@protonmail.ch>; Tue, 21 Apr 2020 22:01:06 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:48120) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jQy8V-000oYz-GL for pontorez@pontorez.com; Tue, 21 Apr
 2020 15:00:57 -0400
...
Authentication-Results: mailin004.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="OmxGLkov"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="g19LuxWr"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=0hJaLeecl5TO19G+EtaeLAU/z3Z4aNiHynS4HtrFqs8=; b=OmxGLkovU7IolLNVW+oKGl4nLG
  OEKIeGOg==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1587495606;
 bh=0hJaLeecl5TO19G+EtaeLAU/z3Z4aNiHynS4HtrFqs8=; h=From:To:Subject:Date;
 b=g19LuxWrC5vnazh4tne28wo2P5xTrNjmtfe1FNvm6+RahzwvbT+JYuwkbIoAM30n4
  rSjdwRT2lbqXX/UBWiDpAODYjoGATjMQp/Yjh7zjs2Cryy/IOJGloUmvJMt+jWjhOL
  84Ba9N0tHo5ODdtj8TXa7GkrxUuNnRQOtcaURQ3M=
...
Subject: [eais#1099523] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Tue, 21 Apr 2020 22:00:06 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/ansambl.hrista.spasitelia.sinagoga .
