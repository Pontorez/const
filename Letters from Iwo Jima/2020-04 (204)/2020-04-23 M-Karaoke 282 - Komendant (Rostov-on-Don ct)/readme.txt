Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin004.protonmail.ch (Postfix) with ESMTP id 55497401007C for
 <pontorez@protonmail.ch>; Thu, 23 Apr 2020 16:20:06 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 785F781720 for
 <pontorez@protonmail.ch>; Thu, 23 Apr 2020 19:16:10 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:39422) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jReTI-00BXhV-53 for pontorez@pontorez.com; Thu, 23 Apr
 2020 12:13:12 -0400
...
Authentication-Results: mailin004.protonmail.ch; spf=pass
 smtp.mailfrom=SRS0=mO2eZT=6H=rkn.gov.ru=zapret-info-out@pontorez.com
Authentication-Results: mailin004.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="EJwuTdje"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="DGsLRsfL"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=LIMOB4F7jo9YhTYoAYFe5rq2emb2r+vOb6Vu5MuS50Q=; b=EJwuTdjex/1LXUbvujCt9BIw5G
  jczyrTtA==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1587657970;
 bh=LIMOB4F7jo9YhTYoAYFe5rq2emb2r+vOb6Vu5MuS50Q=; h=From:To:Subject:Date;
 b=DGsLRsfLzPX9o5Wahm3Jemx+c/aTOfp/iv9QYTH8avbtrdCXXuvN1c0e8hsy0cWAe
  qkV7KzCA+ZJBO4RszJqT6MlSCMXcXtJ/OSW0J9uOPKuKcxkT0JkqHt9lBMbtXTtLFi
  hqRKUiaFdFEPlBaM3qp6hVZNOix0Hmetuhw5M+C4=
...
Subject: [eais#1102038] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Thu, 23 Apr 2020 19:06:10 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/karaoke282-komendant .
