Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin008.protonmail.ch (Postfix) with ESMTP id E51A6300025D for
 <pontorez@protonmail.ch>; Wed, 15 Apr 2020 14:31:07 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 62CD382743 for
 <pontorez@protonmail.ch>; Wed, 15 Apr 2020 17:31:05 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:59706) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jOj45-005tKs-77 for pontorez@pontorez.com; Wed, 15 Apr
 2020 10:31:04 -0400
Authentication-Results: mailin008.protonmail.ch; dmarc=pass (p=quarantine dis=none)
...
Authentication-Results: mailin008.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="NeOf1omN"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="hdOlldg/"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=R582laiqNjxfAdY08q/20L+fuBkL5FuSymydhnz4FxM=; b=NeOf1omN1uUDPnd9ckhXba5Xol
  GK5zMgnA==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1586961016;
 bh=R582laiqNjxfAdY08q/20L+fuBkL5FuSymydhnz4FxM=; h=From:To:Subject:Date;
 b=hdOlldg/n/BrwjIpOUsdVYcRBZXIkatN3Jk4gwNCzaNuoja8B6MdsSeBvfr4fyQqx
  Bp1Uunb9FZr9TcBr6armCLx3DuWqL+A7Q83BpRNOBHsomj/sTFaevbAZI0UITV4ksl
  tCTePVY8tM/TjTYXtTRt7m65fqA1Kj222CJc+S8w=
...
Subject: [eais#1094179] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Wed, 15 Apr 2020 17:30:16 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: https://www2.pontorez.com/kolovrat_kachai_zhelezo .
