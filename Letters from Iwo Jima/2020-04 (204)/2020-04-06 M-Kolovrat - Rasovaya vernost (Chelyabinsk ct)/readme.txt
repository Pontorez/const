Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin007.protonmail.ch (Postfix) with ESMTP id 892A1300026A for
 <pontorez@protonmail.ch>; Mon,
  6 Apr 2020 13:06:23 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 0B3DB80FFD for
 <pontorez@protonmail.ch>; Mon,
  6 Apr 2020 16:05:03 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:51792) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jLQuA-002XKT-QE for pontorez@pontorez.com; Mon, 06 Apr
 2020 08:31:16 -0400
Authentication-Results: mailin007.protonmail.ch; dmarc=pass (p=quarantine dis=none)
 header.from=rkn.gov.ru
Authentication-Results: mailin007.protonmail.ch; spf=pass
 smtp.mailfrom=SRS0=B2NfNY=5W=rkn.gov.ru=zapret-info-out@pontorez.com
Authentication-Results: mailin007.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="UE2X/owt"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="Y1sYtvSP"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=DZwCGYd3Bx3A2vG99vY/u0G6Jj9rsf4UDEzywlDMuPQ=; b=UE2X/owtEwxA3bqyPtwX0vjsD8
  XUvYaAIw==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1586176224;
 bh=DZwCGYd3Bx3A2vG99vY/u0G6Jj9rsf4UDEzywlDMuPQ=; h=From:To:Subject:Date;
 b=Y1sYtvSPdvE4ntMofLB0gCC8A2pp7jAHlDOmIMdkgI6IPzNLMEQ8AisAWcPhKOPVe
  AAb/wdmk32j3uuys8IGb6Sipy0loLa7C60r3DrEvdsFNFOqVbhna3+uazLqLTknw+P
  Q14r0GD8t+qSL/bvoLoBfwlLvR7R/+cTSycgHD2w=
...
Subject: [eais#1078065] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Mon, 6 Apr 2020 15:30:24 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: https://www2.pontorez.com/colovrat-rasovaya-vernost-1 .
