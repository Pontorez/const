Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin007.protonmail.ch (Postfix) with ESMTP id 6160E300025C for
 <pontorez@protonmail.ch>; Wed, 15 Apr 2020 14:32:39 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id B14C28273F for
 <pontorez@protonmail.ch>; Wed, 15 Apr 2020 17:31:16 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:59884) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jOj4B-005tLe-GZ for pontorez@pontorez.com; Wed, 15 Apr
 2020 10:31:10 -0400
...
Authentication-Results: mailin007.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="nVxkeL1/"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="Kh+iDnL/"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=Gn08AWdZpmn84eeA1tUqRYqZGWrmniPSDjTYvzwD4UQ=; b=nVxkeL1/oo4UW1MYJ9Zh9f9x/c
  ax4UTbSQ==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1586961022;
 bh=Gn08AWdZpmn84eeA1tUqRYqZGWrmniPSDjTYvzwD4UQ=; h=From:To:Subject:Date;
 b=Kh+iDnL/EHLzpY5jfOUbZR6sS9Ni3wob+pDMvWwdcZheOWsrCJgdw4T4bluCMHF5I
  LiY7iubl4BA2ch8HaqpL9i8uTc2BhaP0lZrhSS8d4vGCzzql8US/Iifg1lvX56ldnQ
  W3Ud8OXsL4Kga8qNdeAFYADFxZl847RacfnQ8UpI=
...
Subject: [eais#1094305] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Wed, 15 Apr 2020 17:30:21 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/xenia2 .
