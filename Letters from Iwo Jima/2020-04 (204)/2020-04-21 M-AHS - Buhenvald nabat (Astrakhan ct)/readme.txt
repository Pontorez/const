Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin011.protonmail.ch (Postfix) with ESMTP id DB86D401008E for
 <pontorez@protonmail.ch>; Tue, 21 Apr 2020 18:59:00 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 0022382757 for
 <pontorez@protonmail.ch>; Tue, 21 Apr 2020 21:58:59 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:48026) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jQy6b-000o3y-0N for pontorez@pontorez.com; Tue, 21 Apr
 2020 14:58:57 -0400
Authentication-Results: mailin011.protonmail.ch; dmarc=pass (p=quarantine dis=none)
 header.from=rkn.gov.ru
Authentication-Results: mailin011.protonmail.ch; spf=pass
...
Authentication-Results: mailin011.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="k4Jg4vgv"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="a+wo4HD5"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=3v9Va4CI2hmb0YdK29fiS2kmL+CoHO4jdDuQlKL7YmY=; b=k4Jg4vgv/KO+W/A0j17cFAAoQI
  bsSxByQw==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1587495439;
 bh=3v9Va4CI2hmb0YdK29fiS2kmL+CoHO4jdDuQlKL7YmY=; h=From:To:Subject:Date;
 b=a+wo4HD5or5SOFy2LNlrRrYDfFpHGnwrZtl4a6WqDC8hptI5YfyzAC5VHWpnEqXJU
  RkLAb2sGXV6wgCKWqe4v0MK9XkZUvKYyHFPqtGJcqktm0SU8EQFc6ruYo/UFl3m13c
  l3AhNi8fmEsl/cDFaPGYAPmWVXvY9KHS40ffTNY8=
