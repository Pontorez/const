Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin015.protonmail.ch (Postfix) with ESMTP id 55CDB300024F for
 <pontorez@protonmail.ch>; Mon, 27 Apr 2020 15:40:00 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 9748582710 for
 <pontorez@protonmail.ch>; Mon, 27 Apr 2020 18:38:33 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:33082) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jT5po-002TY3-EG for pontorez@pontorez.com; Mon, 27 Apr
 2020 11:38:23 -0400
...
Authentication-Results: mailin015.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="JuZfq/A1"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="csecdmy6"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=n+b+qbpI+TLSTnFx9tfGeg3VQ6K37cCYFQ/k1TZcMkw=; b=JuZfq/A1EDvYpw+h/xQCvKSgOz
  SZi2flfg==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1588001437;
 bh=n+b+qbpI+TLSTnFx9tfGeg3VQ6K37cCYFQ/k1TZcMkw=; h=From:To:Subject:Date;
 b=csecdmy6MCt0jSb1dfw8TdXSBhtG3H9UqySZfp2V7QoGDUqOjtPicCyQeT9aXS06x
  E5O+LCCuKJ6D+QIxrtueLC3MxUKlRxkkCIWwyHbTSYx3nOxQ3Iem4IWhlb+cjSmwG1
  Zcs9nuwI6tky3YtL4USXxGIWgi0nclqUS3Ww9i/Y=
...
Subject: [eais#1105615] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Mon, 27 Apr 2020 18:30:37 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/xblade.for-hatex-nash-vybor .
