Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin012.protonmail.ch (Postfix) with ESMTP id 56B7540124E9 for
 <pontorez@protonmail.ch>; Fri,
  3 Apr 2020 14:33:32 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 552EE82759 for
 <pontorez@protonmail.ch>; Fri,
  3 Apr 2020 17:29:59 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:55356) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jKMWJ-00DIfh-Up for pontorez@pontorez.com; Fri, 03 Apr
 2020 09:38:13 -0400
Authentication-Results: mailin012.protonmail.ch; dmarc=pass (p=quarantine dis=none)
 header.from=rkn.gov.ru
Authentication-Results: mailin012.protonmail.ch; spf=pass
 smtp.mailfrom=SRS0=XpJH9P=5T=rkn.gov.ru=zapret-info-out@pontorez.com
Authentication-Results: mailin012.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="kiNjG62K"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="wfLr4I2b"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=gCs9rJvTRch6rKK/mjNjjJkvybqt8ATQXa3vHdugDQc=; b=kiNjG62KhLAWoHNBT3DnpVlrc8
  rgfzz0KA==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1585920609;
 bh=gCs9rJvTRch6rKK/mjNjjJkvybqt8ATQXa3vHdugDQc=; h=From:To:Subject:Date;
 b=wfLr4I2bUb/1JTZcbSJsC7XFIP6p5FJWz9TTQUG5j1ZCmkIB12PFARDJI5jMdfQ3R
  /RegOu0/xjJuHbqbTDMTp3Pj7TWqsRHJMrBiRxeeY9RI+/DDJyta+7ufz07hAiOWQt
  pJ5VZ/SnjBGO2PC+BEFv4lXdtO56ATTgtRQsXba0=
X-Client-Proxied-By: ROSKOMNADZOR Secured Mail Server
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@pontorez.com>, <pontorez@pm.me>, <abuse@ovh.ca>, <abuse@ovh.ca>
Subject: [eais#1081617] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Fri, 3 Apr 2020 16:30:09 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/kolovrat.vera.v.ns. .
