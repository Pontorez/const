Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin010.protonmail.ch (Postfix) with ESMTP id E95BD3000256 for
 <pontorez@protonmail.ch>; Fri, 17 Apr 2020 13:14:10 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 9B11C81698 for
 <pontorez@protonmail.ch>; Fri, 17 Apr 2020 16:14:08 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:40100) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jPQV5-00F77b-Md for pontorez@pontorez.com; Fri, 17 Apr
 2020 08:54:05 -0400
...
Authentication-Results: mailin010.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="evOVcq7C"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="Z259E/sK"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=nBVQbY6BYimOSaDByq0/pJuxO+6dSzXi1YW2nblqHqQ=; b=evOVcq7CdtYm9SvBP6fgu+ufdv
  KrIdQmHw==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1587127884;
 bh=nBVQbY6BYimOSaDByq0/pJuxO+6dSzXi1YW2nblqHqQ=; h=From:To:Subject:Date;
 b=Z259E/sKinhv62yej4nbsiCX0al4ElQKvn/MscxnUDKuY6y9A4DfTF7tdBASBidVa
  o93dmvfDNQj57+HYMmtbGcnAOSNqnr/+ArzZC7K2S4kbRP+kIKuzIYX7kLDJBkBZNK
  h8Yt+rT2toP8UOnaPWSQf84eV5LuRyM1KtniPgHM=
...
Subject: [eais#1096860] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Fri, 17 Apr 2020 15:51:24 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/calvados_pogrom .
