Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin005.protonmail.ch (Postfix) with ESMTP id 644EB4010093 for
 <pontorez@protonmail.ch>; Fri, 24 Apr 2020 10:17:03 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id EFC5D815DE for
 <pontorez@protonmail.ch>; Fri, 24 Apr 2020 13:11:03 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:47014) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jRvIF-00G81R-9G for pontorez@pontorez.com; Fri, 24 Apr
 2020 06:10:55 -0400
Authentication-Results: mailin005.protonmail.ch; dmarc=pass (p=quarantine dis=none)
 header.from=rkn.gov.ru
Authentication-Results: mailin005.protonmail.ch; spf=pass
 smtp.mailfrom=SRS0=GnVyOK=6I=rkn.gov.ru=zapret-info-out@pontorez.com
Authentication-Results: mailin005.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="eYs7UkJJ"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="rx7ZnF30"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=DbJ9BpF4MlEM9kLBuIxRASzJDLC6AGqJWDfM17IfKNk=; b=eYs7UkJJOU8qnFLzGYEycn/2CW
  oWUBg4ZA==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1587723006;
 bh=DbJ9BpF4MlEM9kLBuIxRASzJDLC6AGqJWDfM17IfKNk=; h=From:To:Subject:Date;
 b=rx7ZnF30/dgAhxzgzeOuH8OnRQJbQrF0DVma3WuZ4KOKuNvDGHLXoV+aaIuX9S+5/
  bIsJVaFjOge/VDwFcBKayYFeP0LrQeeGTt9p/wxTD6LY5ex3ZS+loO/DzbHIN2nyBn
  gmnsGRWQVLqPx8cS2hMzxLpbw5gqjpiDdMJX4Edk=
X-Client-Proxied-By: ROSKOMNADZOR Secured Mail Server
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@pontorez.com>, <pontorez@pm.me>, <noc@ovh.net>
Subject: [eais#1102914] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Fri, 24 Apr 2020 13:10:06 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/managa .
