Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin010.protonmail.ch (Postfix) with ESMTP id 821CC300024B for
 <pontorez@protonmail.ch>; Mon, 13 Apr 2020 16:04:13 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 9D0F28087D for
 <pontorez@protonmail.ch>; Mon, 13 Apr 2020 19:04:05 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:48226) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jO1YC-00DWGO-GY for pontorez@pontorez.com; Mon, 13 Apr
 2020 12:04:04 -0400
...
Authentication-Results: mailin010.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="SRyo1SHl"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="CZr5Qc0f"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=kJDiQlN5R71ef6JZu4zQyGbfWf4RQ5zsTDDk43W3meA=; b=SRyo1SHl7Mx49z5ilh4SsixO5G
  6rWlfi/g==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1586793340;
 bh=kJDiQlN5R71ef6JZu4zQyGbfWf4RQ5zsTDDk43W3meA=; h=From:To:Subject:Date;
 b=CZr5Qc0fpVSbrF0m595Pj3C4cWjtzNDXUy8RDNCdnnoURtk36MAe5zd49D0X+khL9
  ha0LEig/8yXKFsPOLcy89ai8D5HZj+wtF09GabEbbq8xB3+F0eH5H3reH4t0Kr/CWi
  80Rwm4gnwnlqaPXhUY91gVrQKPCCyzHMTYyDpMiM=
...
Subject: [eais#1091090] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Mon, 13 Apr 2020 18:55:40 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: https://www2.pontorez.com/gazeta-vladimirskaya-rus .
