Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin011.protonmail.ch (Postfix) with ESMTP id 7B6214010096 for
 <pontorez@protonmail.ch>; Thu,
  9 Apr 2020 15:36:48 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id DF25D816ED for
 <pontorez@protonmail.ch>; Thu,
  9 Apr 2020 18:29:58 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:57712) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jMYzN-008XYK-0H for pontorez@pontorez.com; Thu, 09 Apr
 2020 11:21:17 -0400
...
Authentication-Results: mailin011.protonmail.ch; spf=pass
 smtp.mailfrom=SRS0=wqbCmC=5Z=rkn.gov.ru=zapret-info-out@pontorez.com
Authentication-Results: mailin011.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="GsINQcRs"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="EBY8K4BP"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=67yXW/AWT6EWrUVeRmqVfoX5hJ7bTuatgoSLSBaC7bw=; b=GsINQcRsPHTxR8/8dw0rDCZHa+
  F3cOnL/w==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1586445627;
 bh=67yXW/AWT6EWrUVeRmqVfoX5hJ7bTuatgoSLSBaC7bw=; h=From:To:Subject:Date;
 b=EBY8K4BP8JGlV6xnm9JLGaoHDws6cFEDJnmTIgjcAJKrglR8GEnLWgmKf//YhFMDb
  8yJZdavGIauY5ohOSLLCVlgGfH4M00lFmYibAmfmn3QYAcLgI3f4VEmbNKRtyIKT9L
  nOu+m0qM+leydHWWGJiTCP/lcWgJqcEyEzPe1tvU=
...
Subject: [eais#1087993] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Thu, 9 Apr 2020 18:20:27 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/korean_pilots_rossiya_dlya_churok .
