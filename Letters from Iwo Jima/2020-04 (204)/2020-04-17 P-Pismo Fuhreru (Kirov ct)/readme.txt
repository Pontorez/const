Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin011.protonmail.ch (Postfix) with ESMTP id 7BEDC401008D for
...
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id A04D981007 for
 <pontorez@protonmail.ch>; Fri, 17 Apr 2020 15:52:06 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:39469) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jPQTN-00F6it-Ky for pontorez@pontorez.com; Fri, 17 Apr
 2020 08:52:05 -0400
...
Authentication-Results: mailin011.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="mVUS3Sg1"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="LEvNeCFc"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=Gy4NaPovFCvWMTi48f/D5WM5YQCOdRe6bw94woa+DIk=; b=mVUS3Sg1zOcOgHtiARiYyAfw9k
  kLK+KCKw==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1587127874;
 bh=Gy4NaPovFCvWMTi48f/D5WM5YQCOdRe6bw94woa+DIk=; h=From:To:Subject:Date;
 b=LEvNeCFcQMIdaIglpT98rjsqVHY4UaPJpnF755NDwdq2j2uwnVVuwSuH7CTciQgit
  PrCWXKlkGDq7LtHTqc/IkNiNkFfREpQ7aW1847vrPhRuyavePFW5eerLov68rUKKzd
  3b30p0x+UuPs7M+veg3c9VMr+OlSLTPg8MkL4lgA=
