Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin011.protonmail.ch (Postfix) with ESMTP id CB5A64010078 for
 <pontorez@protonmail.ch>; Thu, 16 Apr 2020 15:56:02 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id DCD6D81001 for
 <pontorez@protonmail.ch>; Thu, 16 Apr 2020 18:55:54 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:40180) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jP6ri-00Ao4P-5k for pontorez@pontorez.com; Thu, 16 Apr
 2020 11:55:54 -0400
...
Authentication-Results: mailin011.protonmail.ch; spf=pass
 smtp.mailfrom=SRS0=+3QW63=6A=rkn.gov.ru=zapret-info-out@pontorez.com
Authentication-Results: mailin011.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="kUajgL8m"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="dT6ONvOD"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=0AfWyIy7OtGgHfA8BvMXk1kPEoIz4NuSKkFcqFtLFog=; b=kUajgL8m+nb2pwJIwWOgdv5R5p
  xuibt3PQ==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1587052503;
 bh=0AfWyIy7OtGgHfA8BvMXk1kPEoIz4NuSKkFcqFtLFog=; h=From:To:Subject:Date;
 b=dT6ONvODGgkucjbkFR55hrYLJdMkwycB/+oRCG49C9J7Yp1XagD6q3MH+I/QAsfI2
  5nBmMzvwGueWo/aXYA3K+W05JkHDPZnvqAwduwj5gFcyhlJrVELO/Fu/QGhZUtg4Vi
  P0vtH8Wm8RGxIv1w5+zQFtkWVshcJZEizDKmxAOY=
...
Subject: [eais#1095572] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Thu, 16 Apr 2020 18:55:03 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/ciklon_b.v_pamyat_geroyam .
