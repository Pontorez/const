Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin011.protonmail.ch (Postfix) with ESMTP id 771224010AAB for
 <pontorez@protonmail.ch>; Wed, 15 Apr 2020 14:36:53 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 89E5482743 for
 <pontorez@protonmail.ch>; Wed, 15 Apr 2020 17:36:51 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:32958) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jOj9d-005u6W-6x for pontorez@pontorez.com; Wed, 15 Apr
 2020 10:36:50 -0400
...
Authentication-Results: mailin011.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="ZzPmRFaO"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="ksrxldWL"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=FIdPK3hH9ixgWPwOZK5E5V2qg0dqxC/bKEJu7ZfFcwI=; b=ZzPmRFaOjKUJYTOcof0aLy/V03
  cGdpdD7Q==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1586961315;
 bh=FIdPK3hH9ixgWPwOZK5E5V2qg0dqxC/bKEJu7ZfFcwI=; h=From:To:Subject:Date;
 b=ksrxldWLgYe9U7q1xeZKorO8rJ6s5SjoQJZUGsTs7cmDSG9q4jaYru8oXXRU6M2U6
  stJyziSUPk5HmB1AQAOgrqKJt9SDnuuNZLD0zOUWnTaoVBBsOL35HwIGCG4mmOuaQ1
  5+Swx5WnBvuw+HRBCaRCvNWww8QSrJ8vgUFrPrMc=
