Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin006.protonmail.ch (Postfix) with ESMTP id 4E9C2401008B for
 <pontorez@protonmail.ch>; Thu, 30 Apr 2020 11:43:03 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 08DF3816E8 for
 <pontorez@protonmail.ch>; Thu, 30 Apr 2020 14:41:27 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:59832) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jU7Yp-001qhY-WE for pontorez@pontorez.com; Thu, 30 Apr
 2020 07:41:09 -0400
...
Authentication-Results: mailin006.protonmail.ch; spf=pass
 smtp.mailfrom=SRS0=jriSgN=6O=rkn.gov.ru=zapret-info-out@pontorez.com
Authentication-Results: mailin006.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="AQtRStAg"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="Prxre5Cb"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=i7uMXnqBMYXiuitrBgMJdAdOmt1LhFrVlQe/Nc/3NFg=; b=AQtRStAgGuMyU/Z+jCDTqAEZn3
  1qzqn2Og==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1588246818;
 bh=i7uMXnqBMYXiuitrBgMJdAdOmt1LhFrVlQe/Nc/3NFg=; h=From:To:Subject:Date;
 b=Prxre5Cbe3Wd0zlfhTNcWn3m+k9ZLd+RwonXcuXBpgRHVDPo/m7zW6CJVFae3XLFC
  +GuMpeeh6SzbKrvJnFQW6ox7gnGs7zhZoEZOmyOxzmv1cO+5O/armv+l7oXWFpI2hA
  VOFvQItDCnEEGGdwmV0LTcDBR3ZjKpFgRsIQ8n9I=
...
Subject: [eais#1108846] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Thu, 30 Apr 2020 14:40:18 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/tribute_to-the-waffen-ss-my-honor .
