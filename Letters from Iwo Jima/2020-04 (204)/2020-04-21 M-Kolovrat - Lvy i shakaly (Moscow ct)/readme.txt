Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin006.protonmail.ch (Postfix) with ESMTP id 6CF8A4010085 for
 <pontorez@protonmail.ch>; Tue, 21 Apr 2020 18:59:08 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id BF85082757 for
 <pontorez@protonmail.ch>; Tue, 21 Apr 2020 21:59:06 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:48038) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jQy6k-000o5Z-6f for pontorez@pontorez.com; Tue, 21 Apr
 2020 14:59:05 -0400
...
Authentication-Results: mailin006.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="XXl0vMaV"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="tG2QeWUz"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=0YWJcn3Hq8Ww4xcjfc56IQzNdd+uMv3zzaAUTOyQaDI=; b=XXl0vMaVBOhRmM+hadvb5CXtSY
  Qkh/7pbQ==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1587495441;
 bh=0YWJcn3Hq8Ww4xcjfc56IQzNdd+uMv3zzaAUTOyQaDI=; h=From:To:Subject:Date;
 b=tG2QeWUz7q7dYT+w55XEYhqYXoNexGyyo5lWTjvUDPJN/paDFlcHP9v+YJ6i35qct
  vP5NWlq09uHbtrFceI2l2HGjQVOw7JYJPwrgFRIdWZTvbRdFsc05acngvoWwLUtWZq
  wDW9fM1iPpaZG058f+9tQiFH84yglFjLegEd0Dmk=
...
Subject: [eais#1099439] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Tue, 21 Apr 2020 21:57:21 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/kolovrat_lvy.i.shakaly .
