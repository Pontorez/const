Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin004.protonmail.ch (Postfix) with ESMTP id A6FF9402CD27 for
 <pontorez@protonmail.ch>; Mon, 27 Apr 2020 16:11:24 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 3FCCC81121 for
 <pontorez@protonmail.ch>; Mon, 27 Apr 2020 19:11:22 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:60340) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jT5lT-002SfZ-Ez for pontorez@pontorez.com; Mon, 27 Apr
 2020 11:33:54 -0400
...
Authentication-Results: mailin004.protonmail.ch; spf=pass
 smtp.mailfrom=SRS0=yC0nYv=6L=rkn.gov.ru=zapret-info-out@pontorez.com
Authentication-Results: mailin004.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="hOTREl1q"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="DLSkqVHK"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=8AgVEH2GzPnLTDRsm4q7uXFb5bmtDe5emlewp8p5zaA=; b=hOTREl1q/ErMgPUMZxqIDqOGlN
  gZYkA69g==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1588001139;
 bh=8AgVEH2GzPnLTDRsm4q7uXFb5bmtDe5emlewp8p5zaA=; h=From:To:Subject:Date;
 b=DLSkqVHKQ93vdRrTnnnPTXJQtYG4IBLvIk+s3+rezjHa/CXNHJFlxLQrN745KdeNw
  KFu1XuWp90VY+bMd7/fmhdQBtddLKVHo1B2Tb2UDMk+1VHpIYR5Fcu7NLOHgKkYCFj
  c98Vv/jxLfx5X7G8CgCFqOLak2NT5zen4goJbDEk=
...
Subject: [eais#1104778] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Mon, 27 Apr 2020 18:25:39 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/boytsovskiy-klub-cwt .
