Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin008.protonmail.ch (Postfix) with ESMTP id 98D1F300025D for
 <pontorez@protonmail.ch>; Fri, 10 Apr 2020 19:19:10 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id CEB2180EC6 for
 <pontorez@protonmail.ch>; Fri, 10 Apr 2020 22:16:28 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:56052) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jMvdx-00G1e5-GA for pontorez@pontorez.com; Fri, 10 Apr
 2020 11:32:41 -0400
...
Authentication-Results: mailin008.protonmail.ch; spf=pass
 smtp.mailfrom=SRS0=nqe3WL=52=rkn.gov.ru=zapret-info-out@pontorez.com
Authentication-Results: mailin008.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="TS/VLnQj"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="O2VXVQR8"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=DXUIyWHs/dmFIwuV65vmI8Lg5xWtc9YxtljJyNtAVNw=; b=TS/VLnQjwq+VxJU7GY/8Jlhvu+
  cRm0shaQ==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1586532304;
 bh=DXUIyWHs/dmFIwuV65vmI8Lg5xWtc9YxtljJyNtAVNw=; h=From:To:Subject:Date;
 b=O2VXVQR8NQu/6wyXSmBrdOEzKom5B+wtkfBZKeR0fPYLjJ2SHv6gZCRd7O4hzTc04
  q421IiI8ySmO12jflOyGjA96b/9q8zc/S5B7LqLj2v97vezdlW/8dX0r85f/M1hHHv
  63xXi1dgIUTKBZfJltcMzaI/lhR5Si7RJsrSfbXY=
...
Subject: [eais#1089922] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Fri, 10 Apr 2020 18:25:04 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/v-nashem-dome-1 .
