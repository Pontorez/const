Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin011.protonmail.ch (Postfix) with ESMTP id 91C6A401007F for
 <pontorez@protonmail.ch>; Fri, 24 Apr 2020 11:34:49 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 5D9DB81720 for
 <pontorez@protonmail.ch>; Fri, 24 Apr 2020 14:32:23 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:52314) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jRwYR-00GTYM-IV for pontorez@pontorez.com; Fri, 24 Apr
 2020 07:31:44 -0400
...
Authentication-Results: mailin011.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="Gysy51Qg"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="IRKzoyzQ"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=e/o1/eMOTDSySlFElskxES3MY3GF7EFKUteLyiFO+gw=; b=Gysy51QgVVJHpPbY/1eI88CgHn
  NrLuvEYw==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1587727854;
 bh=e/o1/eMOTDSySlFElskxES3MY3GF7EFKUteLyiFO+gw=; h=From:To:Subject:Date;
 b=IRKzoyzQZFgUVdkJ4RouunSbwWwjVLnNpOaTY1wRdqUpUzG3TTqTM628d4jl2DW6a
  cGtjFO9a7inzsPTD9nqvXy9EBv8CmW/VUAuvY96cQgiobwIWQx6wh/L0gupTS/jx2f
  0K70Vz665nEDdZp7yAAKN10qdLRGwIJ9qBSO7+nA=
...
Subject: [eais#1102960] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Fri, 24 Apr 2020 14:30:54 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/griby-1 .
