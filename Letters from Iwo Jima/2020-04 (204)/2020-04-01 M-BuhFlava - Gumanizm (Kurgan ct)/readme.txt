Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin015.protonmail.ch (Postfix) with ESMTP id 958C63000260 for
 <pontorez@protonmail.ch>; Wed,
  1 Apr 2020 16:50:26 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id D4758808A6 for
 <pontorez@protonmail.ch>; Wed,
  1 Apr 2020 19:45:37 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:34038) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jJftB-00ElBU-42 for pontorez@pontorez.com; Wed, 01 Apr
 2020 12:12:42 -0400
...
Authentication-Results: mailin015.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="ZgSs/fYK"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="Qrc1zKdm"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=g+v9tb16bYnzyU4YL9IZ1n9wUeMg8/+svc2UJ+0g+Mc=; b=ZgSs/fYKavRbg5AdPNpQ+QOpcu
  2X1hrvzA==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1585757141;
 bh=g+v9tb16bYnzyU4YL9IZ1n9wUeMg8/+svc2UJ+0g+Mc=; h=From:To:Subject:Date;
 b=Qrc1zKdmD+2j8BaSkXpn7tX8AKC4mIqUJffKbYGcdyOrpPzqfMRa5ZD45QxL7+kYi
  FXy6WZjhl5lpfqZjQhvlbiyznTgMhsjcL6dgMG6aT3EvVJyz664ZvlqwNGbnLgA35D
  lMxE8L0DqdpD/b2bgKNb4GkCMwoIP38GMjE0PHiA=
...
Subject: [eais#1079552] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Wed, 1 Apr 2020 19:05:41 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: https://www2.pontorez.com/buhenvald.flava.gumanizm.i.tolerantnost .
