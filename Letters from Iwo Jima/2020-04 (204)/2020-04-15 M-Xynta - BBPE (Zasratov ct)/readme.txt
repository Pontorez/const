Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin005.protonmail.ch (Postfix) with ESMTP id 64F5C4010092 for
 <pontorez@protonmail.ch>; Wed, 15 Apr 2020 14:31:08 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 898E58273F for
 <pontorez@protonmail.ch>; Wed, 15 Apr 2020 17:31:00 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:59550) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jOj3z-005tKS-KX for pontorez@pontorez.com; Wed, 15 Apr
 2020 10:30:59 -0400
...
Authentication-Results: mailin005.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="dbwGfYmW"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="NBKyGZ9q"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=94aYEvBBv6MKCAySw6GOmSQrl9631e5JIcG3OuORc2M=; b=dbwGfYmWqH66FrMiU5+vQ0K7yL
  PdNkhMxw==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1586961010;
 bh=94aYEvBBv6MKCAySw6GOmSQrl9631e5JIcG3OuORc2M=; h=From:To:Subject:Date;
 b=NBKyGZ9qpb3ufWw8lE1lesmXcj49aZl6oCWaX68DzyJm3BMdarcS6A+hzf5q+fw/m
  QyQKYTfRC2Io/n9YpvU02R96ZZv6euquO/yRzp+yualGipvIEwoNHG+Vu+I0h/FfgP
  nZTQwguRKjEgjJd9DHZ47fesM3/GYyKas5r5dik8=
...
Subject: [eais#1094097] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Wed, 15 Apr 2020 17:30:10 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/the.xynta_bbpe .
