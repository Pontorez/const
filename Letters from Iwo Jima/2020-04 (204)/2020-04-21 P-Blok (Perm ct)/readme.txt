Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin015.protonmail.ch (Postfix) with ESMTP id 2528A3000244 for
...
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 79595809A9 for
 <pontorez@protonmail.ch>; Tue, 21 Apr 2020 22:25:56 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:53420) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jQyWi-000tYh-Du for pontorez@pontorez.com; Tue, 21 Apr
 2020 15:25:55 -0400
...
Authentication-Results: mailin015.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="j++VqMOU"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="PVU6VLFu"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=ZBwb1J5LzPoRLW5jqpX1mOlQGxpaNXv0NiKbpa2JHR4=; b=j++VqMOUbPEL3Mgj4I5BNOSvhW
  3P/JgaiA==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1587497107;
 bh=ZBwb1J5LzPoRLW5jqpX1mOlQGxpaNXv0NiKbpa2JHR4=; h=From:To:Subject:Date;
 b=PVU6VLFu385KxAC4W69QfKFmjcLsIt2RydqR5KTe3ngbGncOAGOLXad9YRYkzN8KT
  RRybZP3WgAVIbLekaBM+DB9+dc+b2LzQn8/4OYpeykk2FhUo+4iTa08hjCZAQFpX7D
  ikxYeVNf7t7werJlDRkCLwxOW9qL21iUoJw0wM+E=
...
Subject: [eais#1100598] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Tue, 21 Apr 2020 22:25:07 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/b1ok .
