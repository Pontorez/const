Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin004.protonmail.ch (Postfix) with ESMTP id 839784010095 for
 <pontorez@protonmail.ch>; Tue, 21 Apr 2020 18:58:59 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 66C9582721 for
 <pontorez@protonmail.ch>; Tue, 21 Apr 2020 21:58:57 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:48024) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jQy6a-000o3p-9m for pontorez@pontorez.com; Tue, 21 Apr
 2020 14:58:56 -0400
Authentication-Results: mailin004.protonmail.ch; dmarc=pass (p=quarantine dis=none)
 header.from=rkn.gov.ru
Authentication-Results: mailin004.protonmail.ch; spf=pass
 smtp.mailfrom=SRS0=AmIScw=6F=rkn.gov.ru=zapret-info-out@pontorez.com
Authentication-Results: mailin004.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="Jv+deLJe"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="Z+HcS8IV"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=aM1/ifw6Ox8MCpKME3w37/aEn8n+zEworyqNb2GXmf8=; b=Jv+deLJeLeGHXx8yI8qjp3lcHx
  Fuigo6jQ==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1587495439;
 bh=aM1/ifw6Ox8MCpKME3w37/aEn8n+zEworyqNb2GXmf8=; h=From:To:Subject:Date;
 b=Z+HcS8IV/h0SA1RmF0WldWXueBMj4vwYngr3k1I+CxImFXQeCm2WdF1KYHNsvZxgP
  1fFSfPcMgKF7gygTBkNIK4qtKnYoFaq/GXcBIRH3k+iWiK6gYNB5QvGOmI4spWG8kF
  +7u+SCA7i5gATCsJVwiZGWW2oBTgt8UFRbkTDkJM=
...
Subject: [eais#1099399] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Tue, 21 Apr 2020 21:57:19 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/ansambl.hrista.spasitelya.kollayder .
