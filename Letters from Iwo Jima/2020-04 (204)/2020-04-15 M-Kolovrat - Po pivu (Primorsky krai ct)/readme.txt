Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin005.protonmail.ch (Postfix) with ESMTP id 65C7B4010091 for
 <pontorez@protonmail.ch>; Wed, 15 Apr 2020 14:36:07 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id 604D882743 for
 <pontorez@protonmail.ch>; Wed, 15 Apr 2020 17:36:05 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:60786) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jOj8u-005u2h-9m for pontorez@pontorez.com; Wed, 15 Apr
 2020 10:36:04 -0400
...
Authentication-Results: mailin005.protonmail.ch; spf=pass
 smtp.mailfrom=SRS0=UeyLPj=57=rkn.gov.ru=zapret-info-out@pontorez.com
Authentication-Results: mailin005.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="k2BZaQ3/"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="nm73JtiZ"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=Zg3DidfYRI+sqtvZHDIhMLZzkj+/fD7SOqYOsQLZdVI=; b=k2BZaQ3/p0u4w4L/1yP7Bzp354
  2TXutSOw==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1586961315;
 bh=Zg3DidfYRI+sqtvZHDIhMLZzkj+/fD7SOqYOsQLZdVI=; h=From:To:Subject:Date;
 b=nm73JtiZSijf1AqU40VEpVF9iOfjulQx5r+QfZZYMQEzLc5N6yz9mMeQ2cmFCnF7I
  VZ5KvV055ZyN0Ojzuji0bMQmBhJ/ry1Z3LUE/pLPrSmGJAifMK+lJ9xnJtadgXKtPm
  jzLV7KIhxplagUqtb8Yda+6pq/rlgtv26zvREnYc=
...
Subject: [eais#1094705] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Wed, 15 Apr 2020 17:35:15 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: http://www2.pontorez.com/kolovrat-druzya-po-pivu .
