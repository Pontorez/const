Received: from smarthost.web-leader.net (smarthost.web-leader.net [107.181.187.94]) by
 mailin006.protonmail.ch (Postfix) with ESMTP id AAC354010092 for
 <pontorez@protonmail.ch>; Mon, 13 Apr 2020 12:11:18 +0000 (UTC)
Received: from ovh-cp1.echo-host.com (cp1.echo-host.com [198.27.106.192]) by
 smarthost.web-leader.net (Postfix) with ESMTPS id D1E3E8087D for
 <pontorez@protonmail.ch>; Mon, 13 Apr 2020 15:11:10 +0300 (MSK)
Received: from mx1.rkn.gov.ru ([87.226.213.147]:58966) by io.web-leader.net with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92) (envelope-from
 <zapret-info-out@rkn.gov.ru>) id 1jNxva-00CosE-Gs for pontorez@pontorez.com; Mon, 13 Apr
 2020 08:11:10 -0400
...
Authentication-Results: mailin006.protonmail.ch; dkim=pass (2048-bit key)
 header.d=pontorez.com header.i=@pontorez.com header.b="fGqaSQ6D"; dkim=pass (1024-bit
 key) header.d=rkn.gov.ru header.i=@rkn.gov.ru header.b="cLDrHVfW"
Dkim-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=pontorez.com;
 ...
 bh=a72zlVt70MRpVLhkJIKruikevGgp4hVRNZX630N97J8=; b=fGqaSQ6D9R4NImA0E8tIZEijQQ
  NXTxovHA==;
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim; t=1586779820;
 bh=a72zlVt70MRpVLhkJIKruikevGgp4hVRNZX630N97J8=; h=From:To:Subject:Date;
 b=cLDrHVfW4biYmqOgRCsusFiDnhKYq8zSiWYzGG8xnUlluLvvML6nk3NJLFdlEUozT
  j4gyKidlskABGPvftKvFyjqj5Xj2FVBStSHLf/kZ8hiWfmHUGcd5j81K+efb58vFgy
  JoFUjkHCDxKtfzLYuUe4CJ/z6xu8NRkW8smQmbKo=
...
Subject: [eais#1091422] Роскомнадзор информирует/the Roscomnadzor is informing
Mime-Version: 1.0
Content-Type: text/plain
Date: Mon, 13 Apr 2020 15:10:20 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: https://pontorez.com/tatu .
