Received: from HE1EUR04HT123.eop-eur04.prod.protection.outlook.com
 (2603:10b6:408:e6::7) by BN6PR1001MB2113.namprd10.prod.outlook.com with HTTPS
 via BN0PR03CA0002.NAMPRD03.PROD.OUTLOOK.COM; Fri, 2 Jul 2021 18:41:18 +0000
...
Received: from mx1.rkn.gov.ru (87.226.213.147) by
 HE1EUR04FT012.mail.protection.outlook.com (10.152.26.92) with Microsoft SMTP
 Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.20.4287.22 via Frontend Transport; Fri, 2 Jul 2021 18:41:16 +0000
X-IncomingTopHeaderMarker:
 OriginalChecksum:AA7EA88C636E496AE2E8D37D2A517FCF183ABCCA24405225452DC939C3F7A8DF;UpperCasedChecksum:73578663351BCA5AE9341AF2289334995710BDA92FF23700D1155E0DC957CF90;SizeAsReceived:862;Count:8
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rkn.gov.ru; s=dkim;
	t=1625251276; bh=OKApJUJuftDupi18FcRJOmx5FTJnrHeaVKYLYqPDS9k=;
	h=From:To:Subject:Date;
	b=ZfrSv0jqb1bHPnSFlX2/rsfYcpijmEC7RtqZMRekBLjzmBhpSgtNFWN1s0/opsIfK
	 qfFUhnV1H8byVkWIb+hGcIh51e0KQM81HoAjZSTh4gyyp1QbXPGRbEdQ2meOVIlRuz
	 hgpMIdos3mSSAywTXfIX2tl1ykOQL1HmWxxU2XbM=
From: Роскомнадзор <zapret-info-out@rkn.gov.ru>
To: <pontorez@hotmail.com>, <conseev@cloudequitygroup.com>, <abuse@dedipath.com>
Subject: [eais#1501896] Роскомнадзор информирует/the Roscomnadzor is informing
Content-Type: multipart/mixed; boundary="5cbe09d644e7c07447f2c0abf9cb6ef4"
Date: Fri,  2 Jul 2021 21:41:15 +0300 (MSK)

Направляется уведомление о внесении в «Единый реестр доменных имен, указателей страниц сайтов в сети «Интернет» и сетевых адресов, позволяющих идентифицировать сайты в сети «Интернет», содержащие информацию, распространение которой в Российской Федерации запрещено» следующего(их) указателя (указателей) страницы (страниц) сайта в сети «Интернет»: https://pontorez.net/_/books/o/otchet_russkim_bogam.pdf .
